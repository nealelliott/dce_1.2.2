...
/*
 * HISTORY
 * $Log: pvpb_thd_002.c,v $
 * Revision 1.1.35.2  1996/02/17  23:32:23  marty
 * 	Update OSF copyright year
 * 	[1996/02/17  22:48:45  marty]
 *
 * Revision 1.1.35.1  1995/12/11  23:05:03  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  22:36:58  root]
 * 
 * Revision 1.1.33.1  1993/10/12  19:38:32  rhw
 * 	Fix for OT8201 - prepend dce to header files
 * 	[1993/10/08  20:31:31  rhw]
 * 
 * Revision 1.1.2.2  1992/12/30  16:56:34  zeliff
 * 	Embedding copyright notice
 * 	[1992/12/30  16:14:36  zeliff]
 * 
 * Revision 1.1  1992/01/19  03:19:49  devrcs
 * 	Initial revision
 * 
 * $EndLog$
 */
...
main ()
    ...
    cts_test ("PVPB_THD_002", "Thread forking (nocached stacks) performance");


    status = pthread_attr_create (&attr);
    check(status,"pthread_attr_create");

    status = pthread_attr_setstacksize (&attr, 1);

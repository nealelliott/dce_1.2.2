 ...
 * HISTORY
 * $Log: cnsclsm.c,v $
 * Revision 1.1.916.2  1996/02/18  00:02:11  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  22:54:53  marty]
 *
 * Revision 1.1.916.1  1995/12/08  00:17:42  root
 * 	Submit OSF/DCE 1.2.1
 * 
 * 	HP revision /main/HPDCE02/jrr_1.2_mothra/1  1995/11/16  21:30 UTC  jrr
 * 	Remove Mothra specific code
 * 
 * 	HP revision /main/HPDCE02/3  1995/08/29  19:01 UTC  tatsu_s
 * 	Submitted the fix for OT13037.
 * 
 * 	HP revision /main/HPDCE02/tatsu_s.psock_timeout.b0/1  1995/08/21  13:13 UTC  tatsu_s
 * 	Initialize RPC_CN_CREP_IOVLEN(call_rep) for a maybe call.
 * 
 ...
 * 	[1995/12/07  23:57:50  root]
 * 
 * Revision 1.1.913.6  1994/08/05  19:49:46  tom
 * 	Bug 11358 - Translate status to message on call_failed errors.
 * 	[1994/08/05  19:06:44  tom]
 * 
 * Revision 1.1.913.5  1994/07/14  21:31:16  tom
 ...
 * 	              event evaluation routine.  Removed
 * 	              DISCARD_FRAG macro, as it is not used.
 * 	[1994/07/11  17:01:31  tom]
 * 
 * Revision 1.1.913.4  1994/06/21  21:53:45  hopkins
 * 	Merged with changes from 1.1.913.3
 * 	[1994/06/21  21:52:57  hopkins]
 * 
 * 	More serviceability
 * 	[1994/06/08  21:29:59  hopkins]
 * 
 * Revision 1.1.913.3  1994/06/20  20:18:28  tom
 * 	Bug 9550 - Caused by the fix for 8068.  When the client faults
 * 	in the server manager routine, the fualt code gets incorrectly
 * 	set to rpc_s_call_orphaned.  So in abort_resp_send_fault_action_rtn()
 * 	don't call abort_resp_action_rtn(), since its redundant anyway.
 * 	[1994/06/20  20:18:17  tom]
 * 
 * Revision 1.1.913.2  1994/01/21  22:34:46  cbrooks
 * 	RPC Code Cleanup - Initial Submission
 * 	[1994/01/21  21:54:29  cbrooks]
 * 
 * 	code cleanup
 * 	[1994/01/17  20:49:47  cbrooks]
 * 
 * Revision 1.1.913.1  1994/01/14  20:31:26  tom
 * 	Fill in the minor version number of the response
 * 	packet with the negotiated value in handle_first_frag_action_rtn.
 * 	[1994/01/13  22:51:21  tom]
 * 
 * Revision 1.1.7.3  1993/08/26  16:44:58  tom
 * 	Bug 8068 - In abort_resp_action_rtn(), set the call status to
 * 	rpc_s_call_orphaned, to prevent the call_end_action_rtn from
 * 	trying to send the remaining iov.
 * 	[1993/08/25  20:14:26  tom]
 * 
 * Revision 1.1.7.2  1993/08/18  19:35:14  tom
 * 	Bug 8274 - Add call_rep as input argument to rpc__cn_assoc_dealloc().
 * 	[1993/08/18  19:16:56  tom]
 * 
 * Revision 1.1.5.4  1993/01/03  22:59:24  bbelch
 * 	Embedding copyright notice
 * 	[1993/01/03  20:00:40  bbelch]
 * 
 * Revision 1.1.5.3  1992/12/23  20:17:51  zeliff
 * 	Embedding copyright notice
 * 	[1992/12/23  15:32:19  zeliff]
 * 
 * Revision 1.1.5.2  1992/10/13  20:54:14  weisman
 * 	     15-sep-92   wh   Fix prototype error.
 * 	     11-aug-92   dm   In stop_orphan_action_rtn(), if call is running
 * 	                      call rpc__cn_assoc_pop_call(), rpc__cn_assoc_dealloc()
 * 	                      and signal the assoc's assoc_msg_cond variable.
 * 	[1992/10/13  20:46:49  weisman]
 * 
 * Revision 1.1.3.3  1992/07/07  21:28:23  rsalz
 * 	     25-Jun-1992 gh   In handle_first_frag_action_rtn(), set the
 * 	                      maybe flag bit in the response header for
 * 	                      maybe calls so that it's available to the
 * 	                      server call state machine predicates.
 * 	     25-jun-92   ko   Bug fix. Add wakeup of call executor thread
 * 	                      when an orphan packet is received just in
 * 	                      case its blocked in rpc_call_receive (which
 * 	                      is not cancellable since the server stubs
 * 	                      disable cancels).
 * 	[1992/07/07  21:24:34  rsalz]
 * 
 * Revision 1.1.3.2  1992/05/22  18:58:04  wei_hu
 * 	12-apr-92   sp   Fix RPC_CN_AUTH_CVT_ID* invocations.  Add missing
 * 	                 assignment of key id in auth_tlr.
 * 	[1992/05/22  18:43:48  wei_hu]
 * 
 * Revision 1.1  1992/01/19  03:09:38  devrcs
 * 	Initial revision
 * 
 * $EndLog$
 */

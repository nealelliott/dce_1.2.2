 ...
 * HISTORY
 * $Log: pipe_server.c,v $
 * Revision 1.1.10.2  1996/03/09  20:51:15  marty
 * 	Add OSF copyright
 * 	[1996/03/09  20:29:05  marty]
 *
 * Revision 1.1.10.1  1995/12/13  21:55:41  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/13  21:45:14  root]
 * 
 * Revision 1.1.6.2  1993/07/09  12:49:53  root
 * 	Initial King Kong branch
 * 	[1993/07/09  12:49:27  root]
 * 
 * Revision 1.1.4.2  1993/03/31  12:29:29  mgm
 * 	Initial GAMERA branch
 * 
 * Revision 1.1.3.2  1992/06/11  19:55:43  mcfarland
 * 	changed files from test_latest
 * 	[1992/06/09  13:03:02  mcfarland]
 * 
 * 	Reorganize util routines
 * 	[1992/04/15  16:00:24  rps]
 * 
 * 	Fix includes
 * 	[1992/03/18  00:12:39  rps]
 * 
 * Revision 1.1.1.2  1992/05/28  15:13:39  root
 * 	    Loading drop Dce1_0_1b15
 * 
 * Revision 1.1  1992/01/19  14:36:49  devrcs
 * 	Initial revision
 * 
 * $EndLog$
 */
 ...
 *   USAGE:
 *
 *      pipe_server -P protocol_sequence -C max_calls -h|H 
 *
 *      where:
 ...
 *	    (e.g.  pipe_server -P ip -C 5)
 *
 *   DESCRIPTION:
 *	This is the general purpose portion of pipe_server.  It basically
 ...
 *						DEC IDL test pipetest2.
 *	12/19/91	Gerald Cantor		Updated prologs.  Changed -M
 *						option to -C.
 */
#include <pipe.h>
#include <stdio.h>
...
char **argv;
{
	...
	CATCH_ALL
	{
		rpc_server_unregister_if(pipetest2_v0_0_s_ifspec, NULL, &st);
...
char *prot;
{
	...
	rpc_server_use_protseq_if(prot, max_calls, pipetest2_v0_0_s_ifspec, 
				  &status);
...
void register_server()
{
	...
	rpc_server_register_if(pipetest2_v0_0_s_ifspec,
				NULL,
				NULL,
				&status);

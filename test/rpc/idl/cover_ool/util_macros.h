 ...
 * HISTORY
 * $Log: util_macros.h,v $
 * Revision 1.1.6.2  1996/02/18  23:05:51  marty
 * 	Update OSF copyright years
 * 	[1996/02/18  22:25:52  marty]
 *
 * Revision 1.1.6.1  1995/12/11  20:02:27  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  19:30:13  root]
 * 
 * Revision 1.1.4.1  1994/06/30  17:58:27  tom
 * 	Remove FREE macro (OT 11148).
 * 	[1994/06/30  17:55:39  tom]
 * 
 * Revision 1.1.2.2  1993/01/07  19:53:36  bbelch
 * 	Embedding copyright notice
 * 	[1993/01/06  13:32:07  bbelch]
 * 
 * Revision 1.1  1992/01/19  03:32:20  devrcs
 * 	Initial revision
 * 
 * $EndLog$
 */
 ...
 *      type    = cast expression for data type of var
 ...
 *      size    = size of memory to allocate
 */
#define RPC_SS_ALLOCATE(type, var, size) \
{ \
    var = type rpc_ss_allocate(size); \
    if (var == type NULL) \
    { \
...
{ \
    ...
    MALLOC((char *), guard1, total_size); \
    MALLOC((cfmt_type *), bmk_cfmt_mem, cfmt_size); \
    cfmt_mem = (cfmt_type *)&guard1[sizeof(guard)]; \

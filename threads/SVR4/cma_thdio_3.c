 ...
 * HISTORY
 * $Log: cma_thdio_3.c,v $
 * Revision 1.1.4.2  1996/02/17  23:33:32  marty
 * 	Update OSF copyright year
 * 	[1996/02/17  22:49:45  marty]
 *
 * Revision 1.1.4.1  1995/12/07  21:57:06  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/07  21:03:41  root]
 * 
 * Revision 1.1.2.2  1994/06/10  20:52:52  devsrc
 * 	cr10872 - fixed copyright
 * 	[1994/06/10  16:49:51  devsrc]
 * 
 * Revision 1.1.2.1  1994/04/14  21:31:57  ohara
 * 	moved again
 * 	[1994/04/14  20:55:38  ohara]
 * 
 * Revision 1.1.2.1  1994/04/01  20:14:56  jd
 * 	Moved from src/threads to here
 * 	[1994/04/01  18:30:56  jd]
 * 
...
#include <dce/cma_dummy_defs_3.h>
...
# include <cma_io_redefs_3.h>    /* Redefinitions for reentrant libs */
...
cma_creat(
	...
	mode_t	mode)
    {
    cma__ts_open (__nr_creat, (path, mode), cma__open_general (__fd__));
    }
...
cma_fcntl (
    ...
    switch (request) {
	     ...
	     * returning it.  
	     */
	    ret_val = __nr_fcntl (fd, request, arg);
...
# endif
	    ...
	    ret_val = __nr_fcntl (fd, request, tmp_arg);

...
FIRSTCPP =             
RC = rc
CFLAGS_D_DEXE = /nologo /G2 /Zp1 /Gy /W3 /Gf /Zi /AL /Od /D "_DEBUG" /D "JAPANESE" /D "_DOS" /FR /Fd"DLIST.PDB"
...
M_DLIST_DEP = c:\client\login\dfam_cli.h \
...
M_DLIST.OBJ:	M_DLIST.C $(M_DLIST_DEP)
	$(CC) $(CFLAGS) $(CCREATEPCHFLAG) /c M_DLIST.C

$(PROJ).EXE::	M_DLIST.OBJ $(OBJS_EXT) $(DEFFILE)
	echo >NUL @<<$(PROJ).CRF
M_DLIST.OBJ +
$(OBJS_EXT)
$(PROJ).EXE

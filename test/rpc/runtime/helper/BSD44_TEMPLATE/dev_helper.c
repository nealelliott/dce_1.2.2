 ...
 * HISTORY
 * $Log: dev_helper.c,v $
 * Revision 1.1.4.2  1996/02/17  23:23:06  marty
 * 	Update OSF copyright year
 * 	[1996/02/17  22:41:43  marty]
 *
 * Revision 1.1.4.1  1995/12/11  20:13:34  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  19:46:36  root]
 * 
 * Revision 1.1.2.2  1993/01/13  19:51:35  bbelch
 * 	Embedding copyright notice
 * 	[1993/01/06  18:19:03  bbelch]
 * 
 * Revision 1.1  1992/01/19  03:43:21  devrcs
 * 	Initial revision
 * 
 * $EndLog$
 */
...
{
    helper_fd = open ("/dev/ncshelper", O_RDWR, 0);
    if (helper_fd < 0) {
        perror("/dev/ncs");
        exit(1);
    }

 ...
 * HISTORY
 * $Log: erchar.c,v $
 * Revision 1.1.8.2  1996/02/18  18:53:55  marty
 * 	Update OSF copyright years
 * 	[1996/02/18  18:06:39  marty]
 *
 * Revision 1.1.8.1  1995/12/07  22:27:03  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/07  21:14:53  root]
 * 
 * Revision 1.1.4.2  1993/07/07  20:06:52  ganni
 * 	reduced stub idl sources
 * 	[1993/07/07  19:36:52  ganni]
 * 
 * $EndLog$
 */
/*
...
#endif
{
  ...
  if (p_node == NULL)
  {
    ...
    if (p_node == NULL) RAISE(rpc_x_no_memory);
  }

...
/*
 * HISTORY
 * $Log: osi_dfs2osferr.c,v $
 * Revision 1.1.13.1  1996/10/02  17:58:18  damon
 * 	Newest DFS from Transarc
 * 	[1996/10/01  18:43:53  damon]
 *
 * $EndLog$
 */
 ...
 */
    err_DFSToLocal[DFS_ENOTSOCK]	= ENOTSOCK;  /* 38 */
    ...
    err_DFSToLocal[DFS_ETOOMANYREFS]	= ETOOMANYREFS;
 ...
 */
    err_DFSToLocal[DFS_EPROCLIM]	= EPROCLIM;
 ...
 */
    ...
    err_DFSToLocal[DFS_EBADRPC] 	= EBADRPC;
    err_DFSToLocal[DFS_ERPCMISMATCH] 	= ERPCMISMATCH;
    err_DFSToLocal[DFS_EPROGUNAVAIL] 	= EPROGUNAVAIL;
    err_DFSToLocal[DFS_EPROGMISMATCH]	= EPROGMISMATCH;
    err_DFSToLocal[DFS_EPROCUNAVAIL]	= EPROCUNAVAIL;
/*
 * misc ..
 */
    err_DFSToLocal[DFS_ENOLCK]		= ENOLCK;
    err_DFSToLocal[DFS_ENOSYS]		= ENOSYS;
    err_DFSToLocal[DFS_EAGAIN]		= EWOULDBLOCK;
 ...
 * STREAMS 
 */
    err_DFSToLocal[DFS_ENOSR]		= ENOSR;
    err_DFSToLocal[DFS_ETIME]		= ETIME;
    err_DFSToLocal[DFS_EBADMSG]		= EBADMSG;
    err_DFSToLocal[DFS_EPROTO]		= EPROTO;
    err_DFSToLocal[DFS_ENODATA]		= ENODATA;
    err_DFSToLocal[DFS_ENOSTR]		= ENOSTR;
		   
/*
 */
    err_DFSToLocal[DFS_ECLONEME]	= ECLONEME;
    err_DFSToLocal[DFS_EDIRTY]		= EDIRTY;
/*
 * loader errors 
 */
    err_DFSToLocal[DFS_EDUPPKG]		= EDUPPKG;
    err_DFSToLocal[DFS_EVERSION]	= EVERSION;
    err_DFSToLocal[DFS_ENOPKG]		= ENOPKG;
    err_DFSToLocal[DFS_ENOSYM]		= ENOSYM;
/* 
 * security ..
 */
 ...
 */
    err_DFSToLocal[DFS_ESOFT]		= ESOFT;
    err_DFSToLocal[DFS_EMEDIA]		= EMEDIA;	
    err_DFSToLocal[DFS_ERELOCATED]	= ERELOCATED;
/*

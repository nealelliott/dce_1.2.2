 ...
 * HISTORY
 * $Log: crc.c,v $
 * Revision 1.1.20.1  1996/10/02  17:26:43  damon
 * 	Newest DFS from Transarc
 * 	[1996/10/01  18:33:31  damon]
 *
 * Revision 1.1.13.2  1994/06/09  14:02:22  annie
 * 	fixed copyright in src/file
 * 	[1994/06/08  21:37:28  annie]
 * 
 * Revision 1.1.13.1  1994/02/04  20:14:36  devsrc
 * 	Merged from 1.0.3a to 1.1
 * 	[1994/02/04  15:11:01  devsrc]
 * 
 * Revision 1.1.11.1  1993/12/07  17:20:12  jaffe
 * 	New File from Transarc 1.0.3a
 * 	[1993/12/02  20:54:46  jaffe]
 * 
 * $EndLog$
 */
/*
 *  $Id: crc.c,v 1.1.20.1 1996/10/02 17:26:43 damon Exp $
...
/* The following function is same as the one in logbuf/crc.c 
 * except that the input argument crc is not zeroed on each call.
 * This allows us to iteratively read in a large file and build
 * the final checksum for the entire file.
 * This also implies that it is the caller's responsibility to
 * to initialize the crc value to zero on the 1st call to this routine.
 */

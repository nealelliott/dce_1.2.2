...
/*
 * HISTORY
 * $Log: prvb_alt_001.c,v $
 * Revision 1.1.63.2  1996/02/17  23:31:41  marty
 * 	Update OSF copyright year
 * 	[1996/02/17  22:48:09  marty]
 *
 * Revision 1.1.63.1  1995/12/11  23:03:05  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  22:36:25  root]
 * 
 * Revision 1.1.61.1  1994/04/01  20:11:44  jd
 * 	First code cleanup drop
 * 	[1994/03/28  21:18:48  jd]
 * 
 * Revision 1.1.59.1  1993/10/12  19:37:29  rhw
 * 	Fix for OT8201 - prepend dce to header files
 * 	[1993/10/08  20:30:58  rhw]
 * 
 * Revision 1.1.4.2  1992/12/30  16:53:53  zeliff
 * 	Embedding copyright notice
 * 	[1992/12/30  16:12:05  zeliff]
 * 
 * Revision 1.1.2.2  1992/05/11  17:08:13  bolinger
 * 	Fix OT defect 2161:  provide/correct missing/bad cts_test() banners.
 * 	[1992/05/11  13:46:21  bolinger]
 * 
 * Revision 1.1  1992/01/19  03:19:36  devrcs
 * 	Initial revision
 * 
 * $EndLog$
 */
...
main ()
    ...
    cts_test ("PRVB_ALT_001", "Basic test of alerts");
    ...
    cts_comment ("part 2: alert waiting thread (pthread_delay_np)");
    status = pthread_create (
		&thread,
		pthread_attr_default,
    ...
    cts_comment ("part 3: alert waiting thread (pthread_cond_timedwait)");
    status = pthread_create (
		&thread,
		pthread_attr_default,
    ...
    cts_comment ("part 4: alert waiting thread (pthread_cond_wait)");
    status = pthread_create (
		&thread,
		pthread_attr_default,
    ...
    cts_comment ("part 6: alert thread doing pthread_thread_join");
    status = pthread_create (
		&thread,
		pthread_attr_default,

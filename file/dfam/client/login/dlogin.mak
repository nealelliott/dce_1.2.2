...
FIRSTCPP =             
RC = rc
CFLAGS_D_DEXE = /nologo /G2 /Zp1 /Gy /W3 /WX /Gf /Zi /AL /Od /D "_DEBUG" /D "_DOS" /D "JAPANESE" /Fc /FR /Fd"DLOGIN.PDB"
...
DLOGIN_DEP = c:\client\login\dfam_cli.h \
...
M_DLOGIN_DEP = c:\client\login\dfam_cli.h \
	c:\sdkcd7\legacy\client\include\nwcaldef.h \
	c:\sdkcd7\legacy\client\include\nwncpext.h \
	c:\sdkcd7\legacy\client\include\nwmisc.h \
	c:\sdkcd7\legacy\client\include\nwcalls.h \
...
DLOGIN.OBJ:	DLOGIN.C $(DLOGIN_DEP)
	$(CC) $(CFLAGS) $(CCREATEPCHFLAG) /c DLOGIN.C

M_DLOGIN.OBJ:	M_DLOGIN.C $(M_DLOGIN_DEP)
	$(CC) $(CFLAGS) $(CUSEPCHFLAG) /c M_DLOGIN.C

$(PROJ).EXE::	DLOGIN.OBJ M_DLOGIN.OBJ $(OBJS_EXT) $(DEFFILE)
	echo >NUL @<<$(PROJ).CRF
DLOGIN.OBJ +
M_DLOGIN.OBJ +
$(OBJS_EXT)

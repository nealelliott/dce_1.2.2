 ...
 * HISTORY
 * $Log: compile_et.c,v $
 * Revision 1.1.11.2  1996/02/18  00:08:27  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  22:59:43  marty]
 *
 * Revision 1.1.11.1  1995/12/08  17:39:33  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/08  16:56:32  root]
 * 
 * Revision 1.1.4.5  1993/02/01  20:36:09  hinman
 * 	[hinman@sni] - Final merge before bsubmit
 * 	[1993/01/31  16:14:37  hinman]
 * 
 * 	[hinman] - Check in merged SNI version
 * 	[1993/01/11  16:12:06  hinman]
 * 
 * Revision 9.5.1.8  93/01/05  16:48:33  meg
 * 	[meg] folded in osf copyright
 * 
 * Revision 9.5.5.3  93/01/05  16:33:17  meg
 * 	[meg] folded in osf copyright notice
 * 
 * Revision 9.5.1.7  92/12/10  14:41:13  meg
 * 	[meg] incorporated osf rev 1.1.4.3
 * 
 * Revision 9.5.5.2  92/12/10  14:40:00  meg
 * 	[meg] incorporated osf rev 1.1.4.3
 * 
 * Revision 9.5.5.2  92/12/10  14:40:00  meg
 * 	[meg] incorporated osf rev 1.1.4.3
 * 
 * Revision 9.12.1.3  92/12/09  16:30:19  root
 * 	Auto checkin of OSF rev 1.1.4.3
 * 
 * Revision 1.1.4.3  1992/12/04  18:15:03  marty
 * 	OSC1.1.1 upgrade.
 * 	[1992/12/04  18:14:31  marty]
 * 
 * Revision 9.5.1.6  92/10/01  16:35:43  chen
 * 	merged Sanjay's changes (elimination of unnecessary SNI_SVR4-specific code)
 * 	into the OSF version -- changes should go back to OSF -- rcc
 * 	Revision 9.5.1.6  92/10/01  16:35:43  chen
 * 	merged Sanjay's changes (elimination of unnecessary SNI_SVR4-specific code)
 * 	into the OSF version -- changes should go back to OSF -- rcc
 * 
 * Revision 1.1.4.2  1992/09/29  21:18:18  devsrc
 * 	[OT 5373]    SNI/SVR4 merge.
 * 	[1992/09/11  21:22:03  sekhar]
 * 
 * Revision 1.1  1992/01/19  14:53:53  devrcs
 * 	Initial revision
 * 
 * $EndLog$
 */
...
/*  compile_et.c V=4 10/23/91 //littl/prgy/krb5/comerr
**
...
static const char rcsid_compile_et_c[] =
    "$Header: /u0/rcs_trees/dce/rcs/security/krb5/comerr/compile_et.c,v 1.1.11.2 1996/02/18 00:08:27 marty Exp $";
#endif
...
static void usage () {
    fprintf (stderr, "%s: usage: %s ERROR_TABLE [-debug] [-language LANG] [-h INCLUDE]\n",
             whoami, whoami);
    exit (1);
}
...
#undef check_lang
    ...
    fputs("static struct et_list link = { (struct et_list *) 0, (struct error_table *) 0 };\n\n",
          cfile);

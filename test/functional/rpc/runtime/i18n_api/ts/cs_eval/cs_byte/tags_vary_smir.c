 ...
 * Revision 1.1.4.2  1996/02/18  00:33:08  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  23:18:34  marty]
 *
 * Revision 1.1.4.1  1995/12/11  19:50:09  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  19:25:56  root]
 * 
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  18:17:16  root]
 * 
 * Revision 1.1.2.2  1994/09/23  19:43:42  mori_m
 * 	CR 11041/11044: New test for varying array operation.
 * 	[1994/09/23  18:32:23  mori_m]
 * 
 * $EndLog$
 */
...
client(void)
{
	...
	mtet_infoline("test case (cs_byte client_tags_vary_array_smir)\n");
	...
	while (rpc_num <= 4)
	{
		...
		temp_status = cs_vary_trans(bind_handle, length + 1, net_string, loc_string);

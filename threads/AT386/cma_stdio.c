 ...
 * HISTORY
 * $Log: cma_stdio.c,v $
 * Revision 1.1.4.2  1996/02/17  23:32:36  marty
 * 	Update OSF copyright year
 * 	[1996/02/17  22:48:57  marty]
 *
 * 	Move latest 1.0.1-based revision into 1.0.2.
 * 	[1992/08/28  20:42:41  bolinger]
 *
 * Revision 1.1.4.1  1995/12/07  21:43:45  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/07  20:58:26  root]
 * 
 * Revision 1.1.2.2  1994/06/09  13:33:37  devsrc
 * 	 CR10892 - fix copyright in file
 * 	[1994/06/09  13:24:51  devsrc]
 * 
 ...
 * 
 * Revision 1.1.2.1  1994/04/01  20:13:07  jd
 * 	Moved from src/threads to here.
 * 	[1994/04/01  16:25:32  jd]
 * 
...
/*
 * MIPS ULTRIX appears to lack definitions for ctermid() & cuserid() under
 * __STDC__, and OSF/1 doesn't like to materialize them even though they
 * appear in unistd.h (under conditionals). Just to be sure these won't
 * conflict, they're conditionalized for MIPS systems.
 */
...
/*
 * On behalf of OSF/1 1.0.4, disable the virtual interval
 * timer that CMA uses for thread timeslicing during calls
 * to the system(3) library function.  This is necessary
 * because the timer is not reset after the new child
 * process is exec()'d, with the result that it can receive
 * an unexpected (and fatal) SIGVTALRM at any time.
 */
extern int
cma_system(
	const char *cmd)

...
/*
 * HISTORY
 * $Log: method_conf_vary_cmir.c,v $
 * Revision 1.1.4.2  1996/02/18  00:32:25  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  23:17:58  marty]
 *
 * Revision 1.1.4.1  1995/12/11  19:48:51  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  19:25:28  root]
 * 
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  18:16:47  root]
 * 
 * Revision 1.1.2.2  1994/09/23  19:39:03  mori_m
 * 	CR 11041/11044: New test for varying array operation.
 * 	[1994/09/23  18:30:50  mori_m]
 * 
 * $EndLog$
 */
...
client()
{
	...
	mtet_infoline("test case (cs_byte client_method_conf_vary_cmir_array)\n");
	...
	fp_out = fopen("./i18n_method_conf_vary_cmir_result_file", "w");
	...
	while (rpc_num <= 4)
	{
		...
		temp_status = cs_conf_vary_trans(bind_handle, SIZE, in_str_len, net_string, loc_string);

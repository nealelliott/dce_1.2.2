...
FIRSTCPP =             
RC = rc
CFLAGS_D_DEXE = /nologo /G2 /Zp1 /Gy /W3 /WX /Gf /Zi /AL /Od /D "_DEBUG" /D "_DOS" /D "JAPANESE" /FR /Fd"DTLIST.PDB"
...
DTLIST_DEP = c:\client\filer\cli_filr.h \
...
DTLIST.OBJ:	DTLIST.C $(DTLIST_DEP)
	$(CC) $(CFLAGS) $(CCREATEPCHFLAG) /c DTLIST.C

$(PROJ).EXE::	DTLIST.OBJ $(OBJS_EXT) $(DEFFILE)
	echo >NUL @<<$(PROJ).CRF
DTLIST.OBJ +
$(OBJS_EXT)
$(PROJ).EXE

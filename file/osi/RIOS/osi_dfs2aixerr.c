...
/*
 * HISTORY
 * $Log: osi_dfs2aixerr.c,v $
 * Revision 1.1.13.1  1996/10/02  17:59:05  damon
 * 	Newest DFS from Transarc
 * 	[1996/10/01  18:44:21  damon]
 *
 * $EndLog$
 */
 ...
 * security 
 */
    err_DFSToLocal[DFS_ENOATTR]	 	= ENOATTR;
    err_DFSToLocal[DFS_ESAD]		= ESAD;
    err_DFSToLocal[DFS_ENOTRUST]	= ENOTRUST;	

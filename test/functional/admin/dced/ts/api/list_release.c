...
/*
 * HISTORY
 * $Log: list_release.c,v $
 * Revision 1.1.4.2  1996/02/18  00:30:32  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  23:16:42  marty]
 *
 * Revision 1.1.4.1  1995/12/11  15:18:53  root
 * 	Submit
 * 	[1995/12/11  14:33:17  root]
 * 
 * Revision 1.1.2.1  1994/09/28  21:48:01  melman
 * 	moved admin tests to test/functional
 * 	[1994/09/28  21:15:41  melman]
 * 
 * Revision 1.1.2.3  1994/07/20  19:57:59  ganni
 * 	introduce the tests for srvrconf and srvrexec services
 * 	[1994/07/20  19:39:57  ganni]
 * 
 * Revision 1.1.2.2  1994/06/17  18:44:42  devsrc
 * 	     cr10872 - fix copyright
 * 	     [1994/06/17  18:32:10  devsrc]
 * 	Revision 1.1.2.1  1994/05/18  21:21:44  ganni
 * 	Initial Version
 * 	[1994/05/18  21:12:03  ganni]
 * 
 * $EndLog$
 */

/*
** Module: 	list_release.c
**
...
void dced_list_release_1(void);		/* Test purposes 1 */
void dced_list_release_2(void);		/* Test purposes 2 */
void dced_list_release_3(void);		/* Test purposes 3 */
void dced_list_release_4(void);		/* Test purposes 4 */
...
{
    { dced_list_release_1,  1 },
    { dced_list_release_2,  2 },
    { dced_list_release_3,  3 },
    { dced_list_release_4,  4 },
    { NULL, 0 }
};
...
dced_list_release_1()
{
	...
	tet_infoline("dced_list_release_1, Assertion 01(A):");
	tet_infoline(
	"When a srvrconf dced binding handle is supplied to ");
	tet_infoline(
	"dced_list_release along with the srvrconf entry list,");
	tet_infoline(
	"the entry list is freed.");
...
dced_list_release_2()
{
	...
	tet_infoline("dced_list_release_2, Assertion 02(A):");
	tet_infoline(
	"When a srvrexec dced binding handle is supplied to ");
	tet_infoline(
	"dced_list_release along with the srvrexec entry list,");
	tet_infoline(
	"the entry list is freed.");
...
dced_list_release_3()
{
	...
	tet_infoline("dced_list_release_3, Assertion 03(A):");
	tet_infoline(
	"When a hostdata dced binding handle is supplied to ");
	tet_infoline(
	"dced_list_release along with the hostdata entry list,");
	tet_infoline(
	"the entry list is freed.");
...
dced_list_release_4()
{
	...
	tet_infoline("dced_list_release_4, Assertion 04(A):");
	tet_infoline(
	"When a keytab dced binding handle is supplied to ");
	tet_infoline(
	"dced_list_release along with the keytab entry list,");
	tet_infoline(
	"the entry list is freed.");

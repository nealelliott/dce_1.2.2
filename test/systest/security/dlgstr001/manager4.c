 ...
 * HISTORY
 * $Log: manager4.c,v $
 * Revision 1.1.4.2  1996/02/17  23:28:35  marty
 * 	Update OSF copyright year
 * 	[1996/02/17  22:45:33  marty]
 *
 * Revision 1.1.4.1  1995/12/11  22:45:40  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  22:21:42  root]
 * 
 * Revision 1.1.2.2  1994/10/06  20:43:56  agd
 * 	expand copyright
 * 	[1994/10/06  14:32:05  agd]
 * 
 * Revision 1.1.2.1  1994/09/19  18:18:15  bhaim
 * 	multidelegate test
 * 	[1994/09/19  17:51:08  bhaim]
 * 
 * $EndLog$
 */
/*
...
#include "common4.h"
#include "identity.h"
#include "string_conv4.h"
#include "string_conv5.h"
#include <dce/binding.h>
#include <dce/secidmap.h>
#include <dce/sec_cred.h>

#define IFSPEC_IN         string_conv4_v1_0_s_ifspec
#define IFSPEC_OUT        string_conv5_v1_0_s_ifspec
#define INTERFACE_NUMBER  conv_4_interface_number
...
void string_convert_uppercase4
(
...
/******/
   ...
   if (num_requested > INTERFACE_NUMBER)
   {
      ...
      sprintf(cds_entry_name, "/.:/subsys/HP/sample-apps/string-convert5");
    ...
    rpc_binding_set_auth_info (
          newbh,
          (unsigned char *)string_conv5_SERVER_PRINCIPAL_NAME,  /* from real-common.h */
      ...
      PRINT_FUNC(PRINT_HANDLE, "Calling string_convert_uppercase5(%s), servers(%s)\n",
		 conv_string, num_serv);

      string_convert_uppercase5(newbh, conv_string, num_serv, auth_status);

      PRINT_FUNC(PRINT_HANDLE, "string_convert_uppercase5 returned \"%s\"\n",
		 conv_string);
   ...
   else
   {
       ...
       */
      PRINT_FUNC(PRINT_HANDLE, ">>> string_convert_uppercase4(%s), servers(%s)\n",
                 conv_string, num_serv);

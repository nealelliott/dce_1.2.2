 ...
 * HISTORY
 * $Log: cnpkt.c,v $
 * Revision 1.1.71.2  1996/02/18  00:01:59  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  22:54:42  marty]
 *
 * Revision 1.1.71.1  1995/12/08  00:17:28  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/07  23:57:42  root]
 * 
 * Revision 1.1.69.3  1994/06/21  21:53:40  hopkins
 * 	More serviceability
 * 	[1994/06/08  21:29:21  hopkins]
 * 
 * 	Serviceability:
 * 	  Use RPC_DCE_SVC_PRINTF instead of EPRINTF
 * 	  RPC_DBG_PRINTF instead of fprintf.
 * 	[1994/05/24  22:11:21  hopkins]
 * 
 * Revision 1.1.69.2  1994/01/21  22:34:35  cbrooks
 * 	RPC Code Cleanyp - Initial Submission
 * 	[1994/01/21  21:54:18  cbrooks]
 * 
 * 	code cleanup
 * 	[1994/01/17  20:49:26  cbrooks]
 * 
 * Revision 1.1.69.1  1994/01/14  20:31:14  tom
 * 	Big PAC - Set minor version in rpc__cn_pkt_format_common().
 * 	[1994/01/13  22:51:06  tom]
 * 
 * Revision 1.1.4.3  1993/01/03  22:59:03  bbelch
 * 	Embedding copyright notice
 * 	[1993/01/03  20:00:05  bbelch]
 * 
 * Revision 1.1.4.2  1992/12/23  20:16:41  zeliff
 * 	Embedding copyright notice
 * 	[1992/12/23  15:31:48  zeliff]
 * 
 * Revision 1.1.2.5  1992/06/23  21:44:01  sekhar
 * 	drop changes made by wei_hu
 * 	[1992/06/23  20:57:29  sekhar]
 * 
 * Revision 1.1.2.4  1992/05/28  20:18:47  rsalz
 * 	     28-may-92    wh      Do not byteswap the key_id.  It's done
 * 	                          by unpack_auth_tlr.
 * 	[1992/05/28  20:15:38  rsalz]
 * 
 * Revision 1.1.2.3  1992/05/22  18:57:39  wei_hu
 * 	12-apr-92    sp      Fix RPC_CN_AUTH_CVT_ID* invocation.
 * 	30-mar-92    af      Fix pointer arithmetic for systems with 64 bit
 * 	                     pointers.  Change cast from (unsigned32) to
 * 	                     (unsigned8 *).
 * 	[1992/05/22  18:43:09  wei_hu]
 * 
 * Revision 1.1  1992/01/19  03:09:31  devrcs
 * 	Initial revision
 * 
 * $EndLog$
 */
...
#endif
{
    ...
    unsigned32 packet_header_overhead;
...
#endif
                RPC_CN_AUTH_TLR_UNPACK (
                RPC_CN_AUTH_CVT_ID_WIRE_TO_API (authp->auth_type, &st),

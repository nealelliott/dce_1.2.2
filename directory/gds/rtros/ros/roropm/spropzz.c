 ...
 * HISTORY
 * $Log: spropzz.c,v $
 * Revision 1.1.4.2  1996/03/11  13:23:12  marty
 * 	Update OSF copyright years
 * 	[1996/03/11  13:11:50  marty]
 *
 * Revision 1.1.4.1  1995/12/08  17:44:02  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/08  16:23:33  root]
 * 
 * Revision 1.1.2.3  1994/06/10  21:12:58  devsrc
 * 	cr10871 - fix copyright
 * 	[1994/06/10  14:53:16  devsrc]
 * 
 * Revision 1.1.2.2  1994/05/10  16:02:28  marrek
 * 	April 1994 code submission.
 * 	[1994/04/27  13:07:18  marrek]
 * 
 * Revision 1.1.2.1  1994/03/23  15:45:50  keutel
 * 	creation
 * 	[1994/03/21  13:35:58  keutel]
 * 
 * $EndLog$
 */
#if !defined(lint) && defined(GDS_RCS_ID)
static char rcsid[] = { "@(#) $RCSfile: spropzz.c,v $ $Revision: 1.1.4.2 $ $Date: 1996/03/11 13:23:12 $" } ;
#endif
...
static char *sccsid =    "@(#) spropzz.c 1.1 93/12/20   RTS-V2.00"; 
...
asn1_pvoid pContext)
  ...
  if( (sterr == OK) && *matchz && *matchz==128 )
    ...
    if( (sterr == OK) && *matchz && RTS_anydef_match(matchz))
      {
      (*x).bArgument = 1;
      sterr=RTS_anydef_dec(hdl,poszm,
                          (unsigned long int FAR *)&(*x).hArgument,
                          (rTro76_stDefinedBy FAR *)&(*x).stOperationValue,3,
                          (void NEAR *)pContext);
      }
    else
      {
...
asn1_pvoid pContext)
  ...
  if ((*x).bArgument != 0)
    {
    RTS_anydef_cod(hdl,-1,0,
                   (unsigned long int FAR *)&(*x).hArgument,
                    (rTro76_stDefinedBy FAR *)&(*x).stOperationValue,1,
                   (void NEAR *)pContext);
    }
  return(ro0063_sterror(hdl));
  }/* sterr ret 5 */
...
asn1_pvoid pContext)
  ...
  unsigned char matchz[6]; /* for SEQ */
    ...
    if( (sterr == OK) && *matchz && RTS_anydef_match(matchz))
      {
      sterr=RTS_anydef_dec(hdl,poszm,
                          (unsigned long int FAR *)&(*x).hResult,
                          (rTro76_stDefinedBy FAR *)&(*x).stOperationValue,4,
                          (void NEAR *)pContext);
      }
    else
      {
...
asn1_pvoid pContext)
  ...
  RTS_anydef_cod(hdl,-1,0,
                 (unsigned long int FAR *)&(*x).hResult,
                 (rTro76_stDefinedBy FAR *)&(*x).stOperationValue,2,
                 (void NEAR *)pContext);
  return(ro0063_sterror(hdl));
  }/* sterr ret 5 */
...
asn1_pvoid pContext)
  ...
  if( (sterr == OK) && *matchz && *matchz==2 )
    ...
    if( (sterr == OK) && *matchz && RTS_anydef_match(matchz))
      ...
      (*x).bParameter = 1;
      sterr=RTS_anydef_dec(hdl,poszm,
                           (unsigned long FAR *)&(*x).hParameter,
                           (rTro76_stDefinedBy FAR *)&(*x).stErrorValue,5,
                           (void NEAR *)pContext);
      }
    else
      {
...
asn1_pvoid pContext)
  ...
  if ((*x).bParameter != 0)
    {
    RTS_anydef_cod(hdl,-1,0,
                  (unsigned long int FAR *)&(*x).hParameter,
                  (rTro76_stDefinedBy FAR *)&(*x).stErrorValue,3,
                  (void NEAR *)pContext);
    }
  return(ro0063_sterror(hdl));
  }/* sterr ret 5 */

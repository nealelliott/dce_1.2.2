 ...
 * HISTORY
 * $Log: cds_mbx.c,v $
 * Revision 1.1.4.2  1996/02/18  19:31:49  marty
 * 	Update OSF copyright years
 * 	[1996/02/18  18:12:44  marty]
 *
 * Revision 1.1.4.1  1995/12/08  15:19:19  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/08  14:44:14  root]
 * 
 * Revision 1.1.2.3  1994/08/24  20:14:10  mccann
 * 	fix server shutdown, add annotation strings, start message delay:OT11239,11245 and 11766
 * 	[1994/08/24  20:07:45  mccann]
 * 
 * Revision 1.1.2.2  1994/08/10  19:21:36  annie
 * 	expand copyright with OSF copyright text
 * 	[1994/08/10  17:15:54  annie]
 * 
 * 	expand copyright with OSF copyright text
 * 
 * 	expand copyright with OSF copyright text
 * 
 * Revision 1.1.2.1  1994/06/30  19:15:54  mccann
 * 	sams cleanup drop2
 * 	[1994/06/30  19:08:12  mccann]
 * 
 * $EndLog$
 */
/*
           ...
           private_mailbox *mbx_p)
{
    ...
    oldasy = pthread_setasynccancel(CANCEL_ON);
    result = dthread_accept(lfd, (struct sockaddr *)&mbx_p->addr, &addrlen);
    (void) pthread_setasynccancel(oldasy);
    return(result);
  }

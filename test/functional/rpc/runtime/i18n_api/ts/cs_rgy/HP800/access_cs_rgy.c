 ...
 * Revision 1.1.4.2  1996/02/18  00:33:56  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  23:19:11  marty]
 *
 * Revision 1.1.4.1  1995/12/11  19:51:29  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  19:26:27  root]
 * 
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  18:17:49  root]
 * 
 * Revision 1.1.2.1  1994/06/22  19:59:27  mori_m
 * 	CR 10043:  Separated access_cs_rgy.c into machine dependent directory.
 * 	[1994/06/22  19:55:56  mori_m]
 * 
 * $EndLog$
 */
...
cs_access1()
{
	...
	dce_cs_loc_to_rgy ((idl_char *)"euc", &code_set, &char_num, &char_sets, &status);

	CHECK_STATUS(TRUE, "dce_cs_loc_to_rgy", status, dce_cs_c_ok);

	mtet_infoline("euc is searched.   code_set = 0x%lX\n", code_set);
...
cs_access3()
{
	...
	dce_cs_loc_to_rgy ((idl_char *)"iso88591", &code_set, &char_num, &char_sets, &status);

	CHECK_STATUS(TRUE, "dce_cs_loc_to_rgy", status, dce_cs_c_ok);

	mtet_infoline("iso88591 is searched.  code_set = 0x%lX\n", code_set);
	mtet_infoline("		   char_num = %d\n", char_num);

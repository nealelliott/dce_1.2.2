 ...
 * HISTORY
 * $Log: manager6.c,v $
 * Revision 1.1.4.2  1996/02/17  23:28:39  marty
 * 	Update OSF copyright year
 * 	[1996/02/17  22:45:35  marty]
 *
 * Revision 1.1.4.1  1995/12/11  22:45:42  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  22:21:44  root]
 * 
 * Revision 1.1.2.2  1994/10/06  20:44:27  agd
 * 	expand copyright
 * 	[1994/10/06  14:32:14  agd]
 * 
 * Revision 1.1.2.1  1994/09/19  18:18:41  bhaim
 * 	multidelegate test
 * 	[1994/09/19  17:51:17  bhaim]
 * 
 * $EndLog$
 */
/*
...
#define IFSPEC_IN         string_conv6_v1_0_s_ifspec
#define INTERFACE_NUMBER  conv_6_interface_number
/*
...
void string_convert_uppercase6
(
...
/******/
   ...
   {
      printf("ERROR: interface number (%s) is too large for this test (max %s)\n",
   ...
   else
   {
       ...
       */
      PRINT_FUNC(PRINT_HANDLE, ">>> string_convert_uppercase6(%s), servers(%s)\n",

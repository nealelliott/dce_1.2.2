...
/*
 * HISTORY
 * $Log: osi_osf2dfserr.c,v $
 * Revision 1.1.13.1  1996/10/02  17:58:33  damon
 * 	Newest DFS from Transarc
 * 	[1996/10/01  18:44:00  damon]
 *
 * $EndLog$
 */
 ...
 * server to map a native (OSF1) KERNEL error to a DFS kernel-independent 
 * error. This routine is called during the DFS server initialization process. 
 * 
 * Note that those kernel errors that are either very OSF/1 specific or 
 ...
 */
    ...
    err_localToDFS[ETOOMANYREFS] 	= DFS_ETOOMANYREFS;
 ...
 */
    ...
    err_localToDFS[EBADRPC] 		= DFS_EBADRPC;
    err_localToDFS[ERPCMISMATCH] 	= DFS_ERPCMISMATCH;
    err_localToDFS[EPROGUNAVAIL] 	= DFS_EPROGUNAVAIL;
    err_localToDFS[EPROGMISMATCH] 	= DFS_EPROGMISMATCH;
    err_localToDFS[EPROCUNAVAIL] 	= DFS_EPROCUNAVAIL;
/*
 */
 ...
 */
    ...
    err_localToDFS[ECLONEME] 		= DFS_ECLONEME;

    err_localToDFS[EDIRTY] 		= DFS_EDIRTY;
    err_localToDFS[EDUPPKG] 		= DFS_EDUPPKG;
    err_localToDFS[EVERSION] 		= DFS_EVERSION;
    ...
    err_localToDFS[ERELOCATED] 		= DFS_ERELOCATED;

...
/*
 * HISTORY
 * $Log: repas_server.c,v $
 * Revision 1.1.10.2  1996/03/09  20:51:24  marty
 * 	Add OSF copyright
 * 	[1996/03/09  20:29:12  marty]
 *
 * Revision 1.1.10.1  1995/12/13  21:55:49  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/13  21:45:19  root]
 * 
 * Revision 1.1.6.2  1993/07/09  13:08:11  root
 * 	Initial King Kong branch
 * 	[1993/07/09  13:07:45  root]
 * 
 * Revision 1.1.4.2  1993/03/31  12:36:28  mgm
 * 	Initial GAMERA branch
 * 
 * Revision 1.1.3.2  1992/06/11  19:57:26  mcfarland
 * 	changed files from test_latest
 * 	[1992/06/09  13:04:34  mcfarland]
 * 
 * 	Reorganize util routines
 * 	[1992/04/15  16:00:43  rps]
 * 
 * Revision 1.1.1.2  1992/05/28  15:14:21  root
 * 	    Loading drop Dce1_0_1b15
 * 
 * Revision 1.1  1992/01/19  14:37:16  devrcs
 * 	Initial revision
 * 
 * $EndLog$
 */
 ...
 *   USAGE:
 *
 *      repas_server -P protocol_sequence -C max_calls -h|H 
 *
 *      where:
 ...
 *	    (e.g.  scal_server -P ip -C 5)
 *
 *   DESCRIPTION:
 *	This is the general purpose portion of repas_server.  It basically
 ...
 *						DEC IDL test repas2.
 *	12/19/91	Gerald Cantor		Updated prologs.  Change -M
 *						option to -C.
 */
...
char **argv;
{
	...
	CATCH_ALL
	{
		rpc_server_unregister_if(repas1_v0_0_s_ifspec, NULL, &st);
...
char *prot;
{
	...
	rpc_server_use_protseq_if(prot, max_calls, repas1_v0_0_s_ifspec, 
				  &status);
...
void register_server()
{
	...
	rpc_server_register_if(repas1_v0_0_s_ifspec,
				NULL,
				NULL,
				&status);

 ...
 * HISTORY
 * $Log: stringc.c,v $
 * Revision 1.1.4.2  1996/02/17  23:22:27  marty
 * 	Update OSF copyright year
 * 	[1996/02/17  22:41:18  marty]
 *
 * Revision 1.1.4.1  1995/12/11  20:10:59  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  19:45:24  root]
 * 
 * Revision 1.1.2.4  1993/01/25  19:28:39  bbelch
 * 	Fix duplicate log
 * 	[1993/01/25  17:45:04  bbelch]
 * 
 * Revision 1.1.2.3  1993/01/11  23:41:21  bbelch
 * 	Embedding copyright notice
 * 	[1993/01/06  18:14:42  bbelch]
 * 
 * Revision 1.1.2.2  1992/10/12  17:41:08  cuti
 * 	Remove hardcoded protocol seq and endpoint instead using all_protoseq.
 * 	[1992/10/09  21:25:16  cuti]
 * 
 * Revision 1.1  1992/01/19  03:37:18  devrcs
 * 	Initial revision
 * 
 * $EndLog$
 */
...
unsigned_char_p_t argv[];
{
    ...
    if (TSHStatus(ctx, SETUP, "rpc_string_binding_compose", status, rpc_s_ok))
       return(status);
    return(strings_test(h, ctx));
}

int strings_test (h, ctx)
handle_t h;
CtxBlock *ctx;
{
    int failures = 0;
    ...
    stringtest_t1 str0_in, str0_out;
    ...
    for (i = 0; i < 100; i += 3) 
    {
        ...
        str0_in[j] = '\000';
        stringtest_op1 (h, str0_in, str0_out);
        /******************************************************************/

 ...
 * Revision 1.2  1996/12/03  10:43:09  salamone
 * Fix headers
 *
                       ...
                       char ***name_argv)
{
    ...
    } /* End of process potential string binding */

    return(rc);

} /* End of dcp_general_split_list() routine */
...
} /* End of dcp_general_allocate_argv_for_one() routine */
                            ...
                            char *attrs[], int *index)
{
    ...
    switch(matches) {
      case 0:
        DCP_SET_RESULT_CODE_ONE_ARG(mcp_s_bad_attribute, key);
        *index = -1;
        return TCL_ERROR;
      case 1:
        return TCL_OK;
      default:
        DCP_SET_RESULT_CODE_ONE_ARG(mcp_s_attr_not_unique, key);
        *index = -1;
        return TCL_ERROR;
    }
}

 ...
 * HISTORY
 * $Log: ast.h,v $
 * Revision 1.1.16.2  1996/02/18  23:44:49  marty
 * 	Update OSF copyright years
 * 	[1996/02/18  22:43:49  marty]
 *
 * Revision 1.1.16.1  1995/12/07  22:12:33  root
 * 	Submit OSF/DCE 1.2.1
 * 
 * 	HP revision /main/dat_xidl2/1  1995/11/17  17:01 UTC  dat
 * 	Merge second XIDL drop for DCE 1.2.1
 * 	[1995/12/07  21:09:35  root]
 * 
 * Revision 1.1.2.1  1995/10/23  01:47:10  bfc
 * 	oct 95 idl drop
 * 	[1995/10/23  01:46:25  bfc]
 * 
 * 	may 95 idl drop
 * 	[1995/10/21  21:29:48  bfc]
 * 
 * 	DCE for DEC OSF/1: populate from OSF DCE 1.1
 * 	[1995/10/21  17:23:15  bfc]
 * 
 * Revision 1.1.12.1  1994/05/02  22:43:25  tom
 * 	From DEC: Add binding callout function.
 * 	[1994/05/02  21:06:24  tom]
 * 
 * Revision 1.1.8.1  1993/10/01  13:27:20  hinxman
 * 	OT 8874 - change design for spelling of #include
 * 	generated from ACF include statement
 * 	[1993/10/01  13:26:47  hinxman]
 * 
 * Revision 1.1.6.2  1993/07/07  19:54:19  ganni
 * 	reduced stub idl sources
 * 	[1993/07/07  19:29:06  ganni]
 * 
 * $EndLog$
 */
/*
 ...
 *   0x00400 |             |         | reclaim     | has_in_ptrs   | in          | in            |
 ...
 * 0x1000000 |             |         |             |               |             | in_fixed      |
 * 0x2000000 |             |         |             |               |             | in_varying    |
 * 0x4000000 |             |         |             |               |             | out_fixed     |
 * 0x8000000 |             |         |             |               |             | out_varying   |
 *0x10000000 |             |         |             |               |             | context_rd    |
 *0x20000000 | amp         | amp     |             |               | amp         | amp           |
 *0x40000000 |             |         |             |               |             | in_pa_stub    |
 *0x80000000 |             |         |             |               |             | out_pa_stub   |
  */
...
#define AST_IN_LINE           0x00000001
#define AST_OUT_OF_LINE       0x00000002

/* flags used in interface, operation attribute flag words */
#define AST_CODE              0x00000004
#define AST_NO_CODE           0x00000008
#define AST_EXPLICIT_HANDLE   0x00010000
#define AST_DECODE            0x00100000
#define AST_ENCODE            0x00200000
#define AST_LOCAL             0x08000000

/* flags used in  operation attribute flag word */
#define AST_BROADCAST         0x00000001
#define AST_MAYBE             0x00000002
#define AST_IDEMPOTENT        0x00000010
#define AST_HAS_INS           0x00000020
#define AST_HAS_IN_PIPES      0x00000040
#define AST_HAS_OUTS          0x00000080
#define AST_HAS_OUT_PIPES     0x00000100
#define AST_HAS_IN_CTX        0x00000200
#define AST_HAS_IN_PTRS       0x00000400
#define AST_HAS_OUT_PTRS      0x00000800
#define AST_HAS_OUT_CTX       0x00001000
#define AST_HAS_OUT_OOLS      0x00002000
#define AST_HAS_IN_OOLS       0x00004000
#define AST_HAS_IN_OUT_CTX    0x00008000
#define AST_ENABLE_ALLOCATE   0x00020000
#define AST_HAS_FULL_PTRS     0x00040000
#define AST_HAS_XMIT_AS       0x00080000
#define AST_REFLECT_DELETIONS 0x00400000
#define AST_STATIC            0x00800000

/* flags used in interface attribute flag word */
#define AST_AUTO_HANDLE       0x00000010
#define AST_NPB               0x00000040
#define AST_IMPLICIT_HANDLE_G 0x00000080
#define AST_DOUBLE_USED       0x00000100
#define AST_HAS_ENCODE_OPS    0x00000200

/* flags used in type, field, parameter attribute flag words */
#define AST_STRING            0x00000004
#define AST_STRING0           0x00000008
#define AST_IGNORE            0x00000040
#define AST_SMALL             0x00000080

/* flags used in type, parameter attribute flag words */
#define AST_HEAP              0x00020000

/* flags used in type flag word */
#define AST_HANDLE            0x00000100
#define AST_SELF_POINTER      0x00001000
#define AST_CONFORMANT        0x00002000
#define AST_DEF_AS_TAG        0x00004000
#define AST_REF               0x00000020
#define AST_UNIQUE            0x00000010
#define AST_PTR               0x00010000
#define AST_UNALIGN           0x00008000
#define AST_V1_ENUM           0x00040000
#define AST_OUT_PA_REF        0x00080000
#define AST_IN_FIXED          0x00100000
#define AST_IN_VARYING        0x00200000
#define AST_OUT_FIXED         0x00400000
#define AST_OUT_VARYING       0x00800000
#define AST_CONTEXT_RD        0x01000000
#define AST_AMP               0x02000000
#define AST_IN_PA_STUB        0x04000000
#define AST_OUT_PA_STUB       0x08000000


/* flags used in parameter flag word */
#define AST_IN                0x00000400
#define AST_OUT               0x00000800
#define AST_COMM_STATUS       0x00001000
#define AST_IN_SHAPE          0x00002000
#define AST_OUT_SHAPE         0x00004000
#define AST_ADD_COMM_STATUS   0x00008000
#define AST_FAULT_STATUS      0x00040000
#define AST_ADD_FAULT_STATUS  0x00080000
#define AST_CS_STAG           0x00100000
#define AST_CS_DRTAG          0x00200000
#define AST_CS_RTAG           0x00400000
#define AST_HIDDEN            0x00800000

/* flag used in parameter and field words */
#define AST_CONTEXT           0x00000100
#define AST_VARYING           0x00000200

/* flag used in field words */

/* flags used in AST_array_index_n_t's flag word */
#define AST_FIXED_LOWER       0x00000001
#define AST_FIXED_UPPER       0x00000002

/* flags used in exception attribute flag words */
#define AST_EXTERN            0x00000001
...
#define AST_AMP_SET(np)        (AST_AMP & (np)->flags)
#define AST_CLR_AMP(np)        (np)->flags &= ~AST_AMP
#define AST_SET_AMP(np)        (np)->flags |= AST_AMP

#define AST_STATIC_SET(np)   (AST_STATIC & (np)->flags)
#define AST_CLR_STATIC(np)   (np)->flags &= ~AST_STATIC
#define AST_SET_STATIC(np)   (np)->flags |= AST_STATIC
...
typedef struct AST_interface_n_t {
    ...
    struct AST_include_n_t *includes;  /* files to include into header */
    struct AST_include_n_t *sincludes; /* files to include into server stub */
    struct AST_include_n_t *cincludes; /* files to include into client stub */
    struct AST_operation_n_t *lookup;  /* lookup callout function name */
    ...
    NAMETABLE_id_t  lookup_callout_name;   /* [cxx_lookup] name if any */
    NAMETABLE_id_t  malloc_callout_name;   /* [client_memory] name if any */
    NAMETABLE_id_t  free_callout_name;     /* [client_memory] name if any */
    NAMETABLE_id_t  cxx_delegate_name;   /* [cxx_delegate] name if any */
    NAMETABLE_id_t  inherited_interface_name;   /* base class interface name */
} AST_interface_n_t;
...
typedef struct AST_operation_n_t {
    ...
    NAMETABLE_id_t     cs_tag_rtn_name; /* [cs_tag_rtn] name if any */
    NAMETABLE_id_t     cxx_new_name; /* used by object creator ops */
    NAMETABLE_id_t     cxx_delegate; /* used by delegate classes */
    NAMETABLE_id_t     cxx_static_name; /* alternate name for static function */
} AST_operation_n_t;

/* macro to determine if an operation is an object creator */
#define IS_CONSTRUCTOR(opp) ((opp)->cxx_new_name != NAMETABLE_NIL_ID)

/* macro to determine if an operation is an object destroyer (TBD) */
#define IS_DESTRUCTOR(opp) (*(BE_get_name((opp)->cxx_new_name)) == '~')

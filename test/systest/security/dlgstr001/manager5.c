 ...
 * HISTORY
 * $Log: manager5.c,v $
 * Revision 1.1.4.2  1996/02/17  23:28:37  marty
 * 	Update OSF copyright year
 * 	[1996/02/17  22:45:34  marty]
 *
 * Revision 1.1.4.1  1995/12/11  22:45:41  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  22:21:43  root]
 * 
 * Revision 1.1.2.2  1994/10/06  20:44:13  agd
 * 	expand copyright
 * 	[1994/10/06  14:32:09  agd]
 * 
 * Revision 1.1.2.1  1994/09/19  18:18:28  bhaim
 * 	multidelegate test
 * 	[1994/09/19  17:51:12  bhaim]
 * 
 * $EndLog$
 */
/*
...
#include "string_conv6.h"
#include <dce/binding.h>
#include <dce/secidmap.h>
#include <dce/sec_cred.h>

#define IFSPEC_IN         string_conv5_v1_0_s_ifspec
#define IFSPEC_OUT        string_conv6_v1_0_s_ifspec
#define INTERFACE_NUMBER  conv_5_interface_number
...
void string_convert_uppercase5
(
...
)
{
   ...
   idl_char              attr_values[256], ent_name[30];
...
/******/
   ...
   if (num_requested > INTERFACE_NUMBER)
   {
      ...
      sprintf(cds_entry_name, "/.:/subsys/HP/sample-apps/string-convert6");
    ...
    rpc_binding_set_auth_info (
          newbh,
          (unsigned char *)string_conv6_SERVER_PRINCIPAL_NAME,  /* from real-common.h */
      ...
      PRINT_FUNC(PRINT_HANDLE, "Calling string_convert_uppercase6(%s), servers(%s)\n",
		 conv_string, num_serv);

      string_convert_uppercase6(newbh, conv_string, num_serv, auth_status);

      PRINT_FUNC(PRINT_HANDLE, "string_convert_uppercase6 returned \"%s\"\n",
		 conv_string);
   ...
   else
   {
       ...
       */
      PRINT_FUNC(PRINT_HANDLE, ">>> string_convert_uppercase5(%s), servers(%s)\n",
                 conv_string, num_serv);

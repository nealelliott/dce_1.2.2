 ...
 * Revision 1.1.4.2  1996/02/18  00:33:57  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  23:19:13  marty]
 *
 * Revision 1.1.4.1  1995/12/11  19:51:36  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  19:26:29  root]
 * 
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  18:17:53  root]
 * 
 * Revision 1.1.2.1  1994/06/22  19:59:30  mori_m
 * 	CR 11043:  Separated access_cs_rgy.c into machine dependent directory.
 * 	[1994/06/22  19:57:37  mori_m]
 * 
 * $EndLog$
 */
...
cs_access1()
{
	...
	dce_cs_loc_to_rgy ((idl_char *)"IBM-eucJP", &code_set, &char_num, &char_sets, &status);

	CHECK_STATUS(TRUE, "dce_cs_loc_to_rgy", status, dce_cs_c_ok);

	mtet_infoline("IBM-eucJP is searched.   code_set = 0x%lX\n", code_set);
...
cs_access5()
{
	...
	dce_cs_rgy_to_loc (0x10020007, &code_name, &char_num, &char_sets, &status);

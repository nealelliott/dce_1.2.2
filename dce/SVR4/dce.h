 ...
 * HISTORY
 * $Log: dce.h,v $
 * Revision 1.1.6.2  1996/02/18  23:32:38  marty
 * 	Update OSF copyright years
 * 	[1996/02/18  22:20:22  marty]
 *
 * Revision 1.1.6.1  1995/12/08  21:35:12  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/08  18:07:04  root]
 * 
 * Revision 1.1.4.5  1994/09/23  19:59:58  tom
 * 	Back out change of unsigned/signed64 to typedef hyper
 * 	[1994/09/23  19:26:45  tom]
 * 
 * Revision 1.1.4.3  1994/08/16  18:12:41  cbrooks
 * 	CR11494 64bit changes
 * 	[1994/08/16  18:12:02  cbrooks]
 * 
 * Revision 1.1.4.2  1994/01/19  17:42:41  cbrooks
 * 	Code Cleanup
 * 	[1994/01/18  22:39:46  cbrooks]
 * 
 * Revision 1.1.4.1  1994/01/14  14:59:34  rousseau
 * 	Changed to use new DCE RFC 34.2 ENDIAN convention.
 * 	[1994/01/14  14:59:01  rousseau]
 * 
 * Revision 1.1.2.1  1993/12/09  23:40:37  melman
 * 	Made dce.h machine specific
 * 	[1993/12/09  23:40:20  melman]
 * 
 * $EndLog$
 */
#if !defined(_DCE_H)
...
/* 
 * Define the endianess of the platform. This is the BSD ENDIAN convention.
 */
#define LITTLE_ENDIAN   1234    /* least-significant byte first (vax) */
#define BIG_ENDIAN      4321    /* most-significant byte first (IBM, net) */
#define PDP_ENDIAN      3412    /* LSB first in word, MSW first in long (pdp) */

#define BYTE_ORDER      LITTLE_ENDIAN   /* byte order on svr4 port */

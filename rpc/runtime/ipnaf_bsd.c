 ...
 * HISTORY
 * $Log: ipnaf_bsd.c,v $
 * Revision 1.1.714.2  1996/02/18  00:04:18  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  22:56:37  marty]
 *
 * Revision 1.1.714.1  1995/12/08  00:20:35  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/07  23:59:29  root]
 * 
 * Revision 1.1.712.6  1994/06/30  19:37:06  ohara
 * 	include sys/sockio.h on SVR4 machines
 * 	[1994/06/30  18:56:10  ohara]
 * 
 * Revision 1.1.712.4  1994/05/27  17:55:46  tatsu_s
 * 	Fixed the update of ip_addr->sa in get_addr(). (Use memcpy())
 * 	[1994/05/27  17:55:12  tatsu_s]
 * 
 * Revision 1.1.712.3  1994/05/27  15:36:52  tatsu_s
 * 	Merged up with DCE1_1.
 * 	[1994/05/20  20:57:36  tatsu_s]
 * 
 * 	DG multi-buffer fragments.
 * 	Added rpc__ip_is_*().
 * 	[1994/05/03  18:31:02  tatsu_s]
 * 
 * Revision 1.1.712.2  1994/05/19  21:14:49  hopkins
 * 	Merge with DCE1_1.
 * 	[1994/05/04  19:42:07  hopkins]
 * 
 * 	Serviceability work.
 * 	[1994/05/03  20:21:57  hopkins]
 * 
 * Revision 1.1.712.1  1994/01/21  22:37:44  cbrooks
 * 	RPC Code Cleanyp - Initial Submission
 * 	[1994/01/21  21:57:49  cbrooks]
 * 
 * Revision 1.1.6.1  1993/09/29  15:09:59  tom
 * 	Bug 8369 - Cast argument to getsockname().
 * 	[1993/09/29  15:09:33  tom]
 * 
 * Revision 1.1.4.3  1993/01/03  23:25:41  bbelch
 * 	Embedding copyright notice
 * 	[1993/01/03  20:07:38  bbelch]
 * 
 * Revision 1.1.4.2  1992/12/23  20:51:26  zeliff
 * 	Embedding copyright notice
 * 	[1992/12/23  15:39:21  zeliff]
 * 
 * Revision 1.1.2.3  1992/06/17  21:45:40  rsalz
 * 	Close socket created in rpc__ip_get_broadcast
 * 	[1992/06/17  19:47:24  rsalz]
 * 
 * Revision 1.1.2.2  1992/05/01  13:37:56  rsalz
 * 	 23-apr-92 nm - Use RPC_SOCKET_FIX_ADDRLEN instead of ad hoc hacking.
 * 	  - Fix returned sockaddr in rpc__ip_desc_inq_addr() as well.
 * 	  - Remove gratuitous error status logic in enumerate_interfaces()
 * 	    (via toml).
 * 	  - Move loopback and "up" check from get_addr() to
 * 	    enumerate_interfaces() (via toml).
 * 	  - Fix NO_SIOCGIFADDR in enumerate_interfaces (via toml).
 * 	  - Use struct sockaddr instead of struct sockaddr_in (via toml).
 * 	 30-mar-92 ko add check for no live interfaces in
 * 	             enumerate interfaces and return error if so
 * 	 06-feb-92 ws 	eliminate a non-portability from the n-2'th change.
 * 	[1992/04/30  23:13:39  rsalz]
 * 
 * Revision 1.1  1992/01/19  03:05:28  devrcs
 * 	Initial revision
 * 
 * $EndLog$
 */

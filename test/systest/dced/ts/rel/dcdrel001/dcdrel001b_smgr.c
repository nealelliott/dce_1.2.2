...
/*
 * HISTORY
 * $Log: dcdrel001b_smgr.c,v $
 * Revision 1.1.4.2  1996/02/17  23:26:47  marty
 * 	Update OSF copyright year
 * 	[1996/02/17  22:44:28  marty]
 *
 * Revision 1.1.4.1  1995/12/11  21:55:36  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  20:55:34  root]
 * 
 * Revision 1.1.2.1  1994/07/21  21:27:20  fadden
 * 	Initial version after renaming
 * 	[1994/07/21  20:37:46  fadden]
 * 
 * $EndLog$
 */
/* 
 ...
 *   interface defined in the IDL file dcdrel001b.idl.
 *
 */
...
void
unregister_obj_all_protseqs_b(
    /* [in]            */	handle_t	h,
    /* [out]           */	error_status_t	*st
);
void
unregister_uuid_all_protseqs_b(
    /* [in]            */	handle_t	h,
    /* [in,string]     */	uuidst_b  	ustring,
    /* [out]           */	error_status_t	*st
);
...
)
{
    ...
    *st = error_status_ok;
    ifspec = &dcdrel001b_v1_0_s_ifspec;
    obj_vec.count = 1;
    obj_vec.uuid[0] = &obj_uuid;
    
    TSTDBG((DBG_LEV2,
	    "register_uuid_all_protseqs_b called with string %s\n",
	    ustring));
...
)
{
    ...
    fprintf(stdout, "register_uuid_vec_all_protseqsb called with array of %d uuids\n",
	    count);
...
)
{
    ...
    *st = error_status_ok;
    ...
    TSTDBG((DBG_LEV6, 
	    "unregister_obj_all_protseqs_b called\n"));
...
)
{
    ...
    *st = error_status_ok;
    ...
    TSTDBG((DBG_LEV6, 
	    "unregister_uuid_all_protseqs_b called with string %s\n",
	    ustring));
    uuid_from_string(ustring, &obj_uuid, st);
    TST_CK_DCE_STATUS(*st, DBG_FATAL, "uuid_from_string", CHK_RET);
    rpc_server_inq_bindings(&bind_vec, st);

 ...
 */
/*
 * $Header: /afs/tr/project/fs/dev/dfs-dev/src/file/osi/HPUX/RCS/osi_cred_mach.h,v 1.4 1995/07/18 22:58:11 blake Exp $
 */
 ...
 */
#define OSI_CR_GROUPS_COUNTED	0
...
#define osi_SetNGroups(c,n) ((c)->cr_groups[n] = NOGROUP)
extern int osi_GetNGroups (osi_cred_t *c);

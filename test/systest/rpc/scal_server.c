 ...
 * HISTORY
 * $Log: scal_server.c,v $
 * Revision 1.1.10.2  1996/03/09  20:51:35  marty
 * 	Add OSF copyright
 * 	[1996/03/09  20:29:20  marty]
 *
 * Revision 1.1.10.1  1995/12/13  21:55:55  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/13  21:45:23  root]
 * 
 * Revision 1.1.6.2  1993/07/09  13:19:43  root
 * 	Initial King Kong branch
 * 	[1993/07/09  13:19:13  root]
 * 
 * Revision 1.1.4.2  1993/03/31  12:37:23  mgm
 * 	Initial GAMERA branch
 * 
 * Revision 1.1.3.2  1992/06/11  19:58:24  mcfarland
 * 	changed files from test_latest
 * 	[1992/06/09  13:05:23  mcfarland]
 * 
 * 	Reorganize util routines
 * 	[1992/04/15  16:01:10  rps]
 * 
 * Revision 1.1.1.2  1992/05/28  15:14:41  root
 * 	    Loading drop Dce1_0_1b15
 * 
 * Revision 1.1  1992/01/19  14:36:56  devrcs
 * 	Initial revision
 * 
 * $EndLog$
 */
 ...
 *   USAGE:
 *
 *      scal_server -P protocol_sequence -C max_calls -h|H 
 *
 *      where:
 ...
 *	    (e.g.  scal_server -P ip -M 5)
 *
 *   DESCRIPTION:
 *	This is the general purpose portion of scalar_server.  It basically
 ...
 *						DEC IDL test scal.
 *	11/11/91	Gerald Cantor		Added default protocol sequence.
...
char **argv;
{
	...
	CATCH_ALL
	{
		rpc_server_unregister_if(scalartest_v2_0_s_ifspec, NULL, &st);
...
char *prot;
{
	...
	rpc_server_use_protseq_if(prot, max_calls, scalartest_v2_0_s_ifspec, 
				  &status);
...
void register_server()
{
	...
	rpc_server_register_if(scalartest_v2_0_s_ifspec,
				NULL,
				NULL,
				&status);

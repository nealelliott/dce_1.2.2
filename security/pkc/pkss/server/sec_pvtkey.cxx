...
//
// HISTORY
// $Log: sec_pvtkey.cxx,v $
// Revision 1.1.2.1  1996/10/03  20:32:51  arvind
// 	OSF DCE 1.2.2 Drop 4
// 	[1996/10/03  19:33:00  arvind]
//
...

{
  ...
  (void) memcpy (&(clt_ctx_p->domain), &domain, sizeof (domain));
  ...
  estatus = pkss_config__init (PKSS_SERVER_NAME);
    ...
    DCE_SVC_DEBUG((pks_svc_handle, pks_s_general, svc_c_debug3,
                   "status from pkss_config__init : %d", estatus));
  ...
  clt_ctx_p->pkss_svc_profile_name_p = pkss_config__cds__service_profile_name();
    ...
    DCE_SVC_DEBUG((pks_svc_handle, pks_s_general, svc_c_debug3,
                   "status from pkss_config__cds__service_profile_name : %d",
		   estatus));
...

{
  ...
  sec_pkss_clt_ctx_t *clt_ctx_p = (sec_pkss_clt_ctx_t *)pk_context_p;
...
} // End sec_pvtkey_update_generate

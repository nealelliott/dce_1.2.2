 ...
 * HISTORY
 * $Log: tags_vary.c,v $
 * Revision 1.1.4.2  1996/02/18  00:33:48  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  23:19:05  marty]
 *
 * Revision 1.1.4.1  1995/12/11  19:51:14  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  19:26:22  root]
 * 
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  18:17:44  root]
 * 
 * Revision 1.1.2.2  1994/09/27  18:47:39  mori_m
 * 	CR 11041:  Corrected length_is value.
 * 	[1994/09/27  18:39:45  mori_m]
 * 
 * Revision 1.1.2.1  1994/09/23  19:05:28  mori_m
 * 	fix comment leaders
 * 	[1994/09/23  19:05:07  mori_m]
 * 
 * 	CR 11041/11044: New test for varying array operation.
 * 	[1994/09/23  18:34:57  mori_m]
 * 
 * $EndLog$
 */
...
client(void)
{
	...
	mtet_infoline("test case (wchar_t client_tags_vary_array)\n");
	...
	fp_out = fopen("./i18n_tags_vary_result_file", "w");
	...
	while (rpc_num <= 4)
	{
		...
		temp_status = cs_vary_trans(bind_handle, w_len + 1, net_string, loc_string);
		...
		else
		{
			...
			if (wcstombs((char *)out_loc_string, loc_string, length) == -1)
			{

 ...
 * HISTORY
 * $Log: roppmze.c,v $
 * Revision 1.1.4.2  1996/02/18  18:22:55  marty
 * 	Update OSF copyright years
 * 	[1996/02/18  17:45:50  marty]
 *
 * Revision 1.1.4.1  1995/12/08  16:13:55  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/08  15:20:05  root]
 * 
 * Revision 1.1.2.4  1994/08/22  15:21:47  keutel
 * 	OT 11620
 * 	[1994/08/19  13:48:11  keutel]
 * 
 * Revision 1.1.2.3  1994/06/10  21:06:06  devsrc
 * 	cr10871 - fix copyright
 * 	[1994/06/10  14:49:17  devsrc]
 * 
 * Revision 1.1.2.2  1994/05/10  15:59:13  marrek
 * 	April 1994 code submission.
 * 	[1994/04/27  12:52:13  marrek]
 * 
 * Revision 1.1.2.1  1994/03/23  15:32:48  keutel
 * 	creation
 * 	[1994/03/21  13:21:25  keutel]
 * 
 * $EndLog$
 */
#if !defined(lint) && defined(GDS_RCS_ID)
static char rcsid[] = { "@(#) $RCSfile: roppmze.c,v $ $Revision: 1.1.4.2 $ $Date: 1996/02/18 18:22:55 $" } ;
#endif
...
static char *sccsid =    "@(#) roppmze.c 1.1 93/11/29   RTS-V2.00"; 
	...
	asn1_pvoid pContext)
{
  ...
  if ((*x).hX410RtpmNode != 0)
    {
    Components_of_set_cod(hdl,2,1,&(*x).hX410RtpmNode,RC104u_RTORQapdu,pContext)
    ;
    }
	...
	asn1_pvoid pContext)
{
  ...
  /* Added by Baiju / Amit on 5-4-94  K02 */   
	...
	if( PDV_list_match(matchz))
	  {
	  sterr=PDV_list_dec(hdl,poszm,&(*FullyData).vPdvList[I_0],pContext);
	  /* Skip unknown components for extensibility */
	  }
	else
	  {
	...
	asn1_pvoid pContext)
{
  ...
  if (asn1_m == -1)
    ...
    for (I_0=0; I_0 < (*FullyData).ulPdvList; I_0++)
      {
      PDV_list_cod(hdl,-1,0,&(*FullyData).vPdvList[I_0],pContext);
      }
    asn1st_deflencod(hdl, posz0);
    }
  return(ro0063_sterror(hdl));

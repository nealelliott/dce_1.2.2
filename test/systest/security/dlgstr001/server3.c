 ...
 * HISTORY
 * $Log: server3.c,v $
 * Revision 1.1.4.2  1996/02/17  23:28:46  marty
 * 	Update OSF copyright year
 * 	[1996/02/17  22:45:39  marty]
 *
 * Revision 1.1.4.1  1995/12/11  22:45:50  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  22:21:49  root]
 * 
 * Revision 1.1.2.2  1994/10/06  20:45:47  agd
 * 	expand copyright
 * 	[1994/10/06  14:32:40  agd]
 * 
 * Revision 1.1.2.1  1994/09/19  18:19:34  bhaim
 * 	multidelegate test
 * 	[1994/09/19  17:51:31  bhaim]
 * 
 * $EndLog$
 */
/*
...
string_conv3_v1_0_epv_t string_conv3_v1_0_s_epv =
    { string_convert_uppercase3 };

#define IFSPEC                  string_conv3_v1_0_s_ifspec
#define MANAGER_EPV             (rpc_mgr_epv_t) &string_conv3_v1_0_s_epv
...
setup_sigcatch(&sigcatch_thread);
    ...
    */
   establish_identity(
      string_conv3_AUTHN_SVC,
      (unsigned char *)string_conv3_SERVER_PRINCIPAL_NAME,

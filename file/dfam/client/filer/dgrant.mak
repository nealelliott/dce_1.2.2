...
FIRSTCPP =             
RC = rc
CFLAGS_D_DEXE = /nologo /G2 /Zp1 /Gy /W3 /Gf /Zi /AL /Od /D "_DEBUG" /D "_DOS" /D "JAPANESE" /FR /Fd"DGRANT.PDB"
...
DGRANT_DEP = c:\client\filer\cli_filr.h \
...
DGRANT.OBJ:	DGRANT.C $(DGRANT_DEP)
	$(CC) $(CFLAGS) $(CCREATEPCHFLAG) /c DGRANT.C

$(PROJ).EXE::	DGRANT.OBJ $(OBJS_EXT) $(DEFFILE)
	echo >NUL @<<$(PROJ).CRF
DGRANT.OBJ +
$(OBJS_EXT)
$(PROJ).EXE

 ...
 * HISTORY
 * $Log: method_conf.c,v $
 * Revision 1.1.4.2  1996/02/18  00:33:14  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  23:18:37  marty]
 *
 * Revision 1.1.4.1  1995/12/11  19:50:25  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  19:26:02  root]
 * 
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  18:17:22  root]
 * 
 * Revision 1.1.2.3  1994/09/27  18:47:28  mori_m
 * 	CR 11041:  'size_is' value should be (wcslen+1) * sizeof(wchar_t).
 * 	[1994/09/27  18:35:36  mori_m]
 * 
 * Revision 1.1.2.2  1994/09/23  19:30:48  mori_m
 * 	CR 11041/11044: New test for varying array operation.
 * 	[1994/09/23  18:33:46  mori_m]
 * 
 * $EndLog$
 */
...
client()
{
	...
	mtet_infoline("test case (cs_byte client_method_conf_array)\n");
	...
	while (!feof(fp_in))
	{
		...
		in_str_len = (long)strlen(in_net_string) + 1;

		w_len = mbstowcs(net_string, (char *)in_net_string, (size_t)in_str_len);
		...
		temp_status = cs_conf_trans(bind_handle, (w_len + 1) * sizeof(wchar_t), net_string, loc_string);
		...
		else
		{
			...
			if (wcstombs((char *)out_loc_string, loc_string, in_str_len) == -1)
			{

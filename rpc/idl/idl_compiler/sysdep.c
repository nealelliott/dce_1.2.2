 ...
 * HISTORY
 * $Log: sysdep.c,v $
 * Revision 1.1.8.2  1996/02/18  18:52:40  marty
 * 	Update OSF copyright years
 * 	[1996/02/18  18:05:52  marty]
 *
 * Revision 1.1.8.1  1995/12/07  22:22:18  root
 * 	Submit OSF/DCE 1.2.1
 * 
 * 	HP revision /main/dat_xidl2/1  1995/11/17  17:05 UTC  dat
 * 	Merge second XIDL drop for DCE 1.2.1
 * 	[1995/12/07  21:13:10  root]
 * 
 * Revision 1.1.2.1  1995/10/31  21:15:36  bfc
 * 	may 5 version from nightly
 * 	[1995/10/31  20:49:57  bfc]
 * 
 * 	DCE for DEC OSF/1: populate from OSF DCE R1.1
 * 	[1995/10/31  20:47:14  bfc]
 * 
 * Revision 1.1.4.2  1993/07/07  20:04:01  ganni
 * 	reduced stub idl sources
 * 	[1993/07/07  19:34:54  ganni]
 * 
 * $EndLog$
 */
/*
...

{
    ...
    char temp;
    int i, j, len, new_len, chars_written;
    ...
    */
    ...
    chars_written = vsprintf (&buff[buff_len], new_format, args);
    buff_len += chars_written;

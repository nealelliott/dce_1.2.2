 ...
 * HISTORY
 * $Log: cncall.c,v $
 * Revision 1.1.18.3  1996/10/03  14:41:43  arvind
 * 	silence purify.
 * 	[1996/09/16  19:57 UTC  sommerfeld  /main/DCE_1.2.2/sommerfeld_pk_kdc_1/1]
 *
 * 	Submit OSF/DCE 1.2.1
 * 	HP 	[1995/11/16  21:29 UTC  jrr  /main/HPDCE02/gaz_dce_instr/jrr_1.2_mothra/1]
 *
 * 	Remove Mothra specific code
 * 	HP 	[1995/08/17  04:18 UTC  gaz  /main/HPDCE02/gaz_dce_instr/5]
 *
 * 	Ensure that DMS is NOT built in the Kernel RPC
 * 	HP 	[1995/07/25  14:53 UTC  gaz  /main/HPDCE02/gaz_dce_instr/4]
 *
 * 	Timestamp call departure when calltag is detached from call_rep
 * 	add conditional compilation directives
 * 	HP 	[1995/07/17  20:41 UTC  gaz  /main/HPDCE02/gaz_dce_instr/3]
 *
 * 	Merge out fix for OT12885
 * 	HP 	[1995/06/30  21:06 UTC  tatsu_s  /main/HPDCE02/6]
 *
 * 	Submitted the fix for OT12885.
 * 	HP 	[1995/06/20  20:36 UTC  tatsu_s  /main/HPDCE02/tatsu_s.fix_ot12885.b1/1]
 *
 * 	Fragment's user data length must be a multiple of 8-bytes.
 * 	HP 	[1995/07/15  20:21 UTC  gaz  /main/HPDCE02/gaz_dce_instr/2]
 *
 * 	add code to detach DMS calltag from call_rep and queue for tally
 * 	add code to count CN rejected calls
 * 	HP 	[1995/07/05  16:09 UTC  gaz  /main/HPDCE02/gaz_dce_instr/1]
 *
 * 	initialize DMS calltag pointer in newly allocated call_rep to NULL
 * 	HP 	[1995/05/25  21:39 UTC  lmm  /main/HPDCE02/5]
 *
 * 	Merge allocation failure detection cleanup work
 * 	HP 	[1995/05/25  21:00 UTC  lmm  /main/HPDCE02/lmm_alloc_fail_clnup/1]
 *
 * 	allocation failure detection cleanup
 * 	HP 	[1995/04/02  01:13 UTC  lmm  /main/HPDCE02/4]
 *
 * 	Merge allocation failure detection functionality into Mothra
 * 	HP 	[1995/04/02  00:17 UTC  lmm  /main/HPDCE02/lmm_rpc_alloc_fail_detect/1]
 *
 * 	add memory allocation failure detection
 * 	HP 	[1995/03/06  17:18 UTC  tatsu_s  /main/HPDCE02/3]
 *
 * 	Submitted the local rpc security bypass.
 * 	HP 	[1995/02/22  22:31 UTC  tatsu_s  /main/HPDCE02/tatsu_s.local_rpc.b1/1]
 *
 * 	Local RPC Security Bypass.
 * 	HP 	[1995/01/04  18:25 UTC  tatsu_s  /main/HPDCE02/2]
 *
 * 	Submitted CN orpahned assoc fix.
 * 	HP 	[1995/01/04  02:08 UTC  tatsu_s  /main/HPDCE02/tatsu_s.mothra_cn_fix.b0/1]
 *
 * 	Fixed binding_serialize.
 * 	HP 	[1994/12/09  19:13 UTC  tatsu_s  /main/HPDCE02/1]
 *
 * 	Submitted rfc31.0: Single-threaded DG client and RPC_PREFERRED_PROTSEQ.
 * 	HP 	[1994/12/07  20:58 UTC  tatsu_s  /main/tatsu_s.st_dg.b0/2]
 *
 * 	rfc31.0: Cleanup.
 * 	HP 	[1994/11/30  22:25 UTC  tatsu_s  /main/tatsu_s.st_dg.b0/1]
 * 	[1996/10/03  13:26:06  arvind]
 *
 * Revision 1.1.18.2  1996/06/04  21:53:42  arvind
 * 	u2u: Pass handle  from rpc__cn_call_start() to RPC_CN_AUTH_CRED_REFRESH()
 * 	[1996/05/06  20:16 UTC  burati  /main/DCE_1.2/3]
 * 
 * 	merge up  to latest from DCE_1.2
 * 	[1996/05/01  19:50 UTC  burati  /main/DCE_1.2/mb_u2u/2]
 * 
 * 	Update OSF copyright years
 * 	[1996/02/17  22:54:18  marty]
 * 
 * 	Submit OSF/DCE 1.2.1
 * 	HP 	[1995/11/16  21:29 UTC  jrr  /main/HPDCE02/gaz_dce_instr/jrr_1.2_mothra/1]
 * 
 ...
 * 	[1995/12/07  23:57:22  root]
 * 
 * Revision 1.1.18.1  1996/05/10  13:09:09  arvind
 * 	Drop 1 of DCE 1.2.2 to OSF
 * 
 * 	HP revision /main/DCE_1.2/2  1996/04/18  19:10 UTC  bissen
 * 	unifdef for single threaded client
 * 	[1996/02/29  20:41 UTC  bissen  /main/HPDCE02/bissen_st_rpc/1]
 * 
 * 	HP revision /main/DCE_1.2/1  1996/01/03  18:58 UTC  psn
 * 	Remove Mothra specific code
 * 	[1995/11/16  21:29 UTC  jrr  /main/HPDCE02/gaz_dce_instr/jrr_1.2_mothra/1]
 * 
 * 	Ensure that DMS is NOT built in the Kernel RPC
 * 	[1995/08/17  04:18 UTC  gaz  /main/HPDCE02/gaz_dce_instr/5]
 * 
 * 	Timestamp call departure when calltag is detached from call_rep
 * 	add conditional compilation directives
 * 	[1995/07/25  14:53 UTC  gaz  /main/HPDCE02/gaz_dce_instr/4]
 * 
 * 	Merge out fix for OT12885
 * 	[1995/07/17  20:41 UTC  gaz  /main/HPDCE02/gaz_dce_instr/3]
 * 
 * 	Submitted the fix for OT12885.
 * 	[1995/06/30  21:06 UTC  tatsu_s  /main/HPDCE02/6]
 * 
 * 	Fragment's user data length must be a multiple of 8-bytes.
 * 	[1995/06/20  20:36 UTC  tatsu_s  /main/HPDCE02/tatsu_s.fix_ot12885.b1/1]
 * 
 * 	add code to detach DMS calltag from call_rep and queue for tally
 * 	add code to count CN rejected calls
 * 	[1995/07/15  20:21 UTC  gaz  /main/HPDCE02/gaz_dce_instr/2]
 * 
 * 	initialize DMS calltag pointer in newly allocated call_rep to NULL
 * 	[1995/07/05  16:09 UTC  gaz  /main/HPDCE02/gaz_dce_instr/1]
 * 
 * 	Merge allocation failure detection cleanup work
 * 	[1995/05/25  21:39 UTC  lmm  /main/HPDCE02/5]
 * 
 * 	allocation failure detection cleanup
 * 	[1995/05/25  21:00 UTC  lmm  /main/HPDCE02/lmm_alloc_fail_clnup/1]
 * 
 * 	Merge allocation failure detection functionality into Mothra
 * 	[1995/04/02  01:13 UTC  lmm  /main/HPDCE02/4]
 * 
 * 	add memory allocation failure detection
 * 	[1995/04/02  00:17 UTC  lmm  /main/HPDCE02/lmm_rpc_alloc_fail_detect/1]
 * 
 * 	Submitted the local rpc security bypass.
 * 	[1995/03/06  17:18 UTC  tatsu_s  /main/HPDCE02/3]
 * 
 * 	Local RPC Security Bypass.
 * 	[1995/02/22  22:31 UTC  tatsu_s  /main/HPDCE02/tatsu_s.local_rpc.b1/1]
 * 
 * 	Submitted CN orpahned assoc fix.
 * 	[1995/01/04  18:25 UTC  tatsu_s  /main/HPDCE02/2]
 * 
 * 	Fixed binding_serialize.
 * 	[1995/01/04  02:08 UTC  tatsu_s  /main/HPDCE02/tatsu_s.mothra_cn_fix.b0/1]
 * 
 * 	Submitted rfc31.0: Single-threaded DG client and RPC_PREFERRED_PROTSEQ.
 * 	[1994/12/09  19:13 UTC  tatsu_s  /main/HPDCE02/1]
 * 
 * 	rfc31.0: Cleanup.
 * 	[1994/12/07  20:58 UTC  tatsu_s  /main/tatsu_s.st_dg.b0/2]
 * 
 * 	rfc31.0: Initial version.
 * 	[1994/11/30  22:25 UTC  tatsu_s  /main/tatsu_s.st_dg.b0/1]
 * 
 * Revision 1.1.12.4  1994/07/14  21:31:00  tom
 * 	     01-jun-93       us  Added state tbl ID to rpc_cn_sm_init.
 * 	                         Use the ID in the rpc protocol to bypass
 * 	                         the event engine and go directly to the
 ...
 * 	                         see cnsm.c comments.
 * 	[1994/07/11  16:44:22  tom]
 * 
 * Revision 1.1.12.3  1994/05/19  21:14:21  hopkins
 * 	Merge with DCE1_1.
 * 	[1994/05/04  19:36:00  hopkins]
 * 
 * 	Serviceability work.
 * 	[1994/05/03  20:17:14  hopkins]
 * 
 * Revision 1.1.12.2  1994/03/17  23:06:33  tom
 * 	Big PAC:
 * 	  In call_start, set packet header to the negotiated minor version.
 * 	  Remove extra assign of buff_dealloc in rpc__cn_call_transceive.
 * 	[1994/03/17  23:04:02  tom]
 * 
 * Revision 1.1.12.1  1994/01/21  22:33:55  cbrooks
 * 	RPC Code Cleanyp - Initial Submission
 * 	[1994/01/21  21:53:37  cbrooks]
 * 
 ...
 * 	for no action with transmit_req and last_transmit_req events
 * 	in call_failed and cf_dne states.
 * 	[1993/09/14  18:29:08  ganni]
 * 
 * Revision 1.1.9.1  1993/09/01  20:02:47  ganni
 * 	Bug 7681 - check for the cancels after sendmsg in transceive()
 * 	[1993/09/01  20:01:40  ganni]
 * 
 * Revision 1.1.7.4  1993/08/26  17:52:54  tatsu_s
 * 	*** empty log message ***
 * 
 * Revision 1.1.7.3  1993/08/26  16:44:53  tom
 * 	Bug 8068 - Initialize call_rep in rpc__cn_call_start().
 * 	[1993/08/25  20:12:55  tom]
 * 
 * Revision 1.1.7.2  1993/08/18  19:34:59  tom
 * 	Bug 8274 - Add call_rep as input argument to rpc__cn_assoc_dealloc().
 * 	[1993/08/18  19:16:48  tom]
 * 
 * Revision 1.1.5.7  1993/04/08  20:40:12  kwo
 * 	     07-apr-93   ko      Move check for NULL call rep in
 * 	                              rpc__cn_call_local_cancel to the
 * 	                              start of the routine.
 * 	[1993/04/08  20:38:32  kwo]
 * 
 * Revision 1.1.5.6  1993/04/07  20:51:08  kwo
 * 	     06-apr-93   ko      Check for NULL call rep in
 * 	                         rpc__cn_call_local_cancel. If NULL, the
 * 	                         call has been orphaned and return
 * 	                         rpc_s_call_cancelled.
 * 	                         Return rpc_s_call_cancelled instead of
 * 	                         rpc_s_call_orphaned when the call is
 * 	                         orphaned. This matches what the server
 * 	                         stub expects and what the DG protocol does.
 * 	[1993/04/07  20:49:36  kwo]
 * 
 * Revision 1.1.5.5  1993/01/03  22:58:13  bbelch
 * 	Embedding copyright notice
 * 	[1993/01/03  19:58:42  bbelch]
 * 
 * Revision 1.1.5.4  1992/12/23  20:13:36  zeliff
 * 	Embedding copyright notice
 * 	[1992/12/23  15:30:30  zeliff]
 * 
 * Revision 1.1.5.3  1992/12/18  19:53:17  wei_hu
 * 	     23-nov-92    ebm    Fix deadlock caused by not freeing condition
 * 	                         for serializing access to binding handle as
 * 	                         well as optimizing call to binding_serialize
 * 	                         for only those callers that need to wait.
 * 	[1992/12/18  19:43:04  wei_hu]
 * 
 * Revision 1.1.5.2  1992/10/13  20:53:27  weisman
 * 	15-sep-92    ko     Add a call to the CRED_REFRESH auth entry
 * 	                    point at the beginning of call_start if the
 * 	                    call requires authentication.
 * 	15-sep-92    wh     Fix prototype error.
 * 	26-aug-92    dm     In rpc__cn_call_start(), init call_rep->sec to NULL.
 * 	18-aug-92    dm     In rpc__cn_call_receive() check for orphan status
 * 	                    before last frag. If orphaned, we want a non-ok
 * 	                    status returned to the stub.
 * 	10-aug-92    dm     If rpc__cn_call_start() has a problem getting an
 * 	                    endpoint from rpcd, cleanup by calling
 * 	                    rpc__cn_call_end().
 * 	29-jul-92    dm     Modify rpc__cn_call_transmit_fault not to send a
 * 	                    response event through the state machine if the
 * 	                    call has been orhpaned. This is the same as in
 * 	                    rpc__cn_call_transmit.
 * 	27-jul-92    dm     In rpc__cn_call_end():
 * 	                    -  Use the local call_rep rather than call_r to
 * 	                       prevent using a NULL pointer after calling
 * 	                       rpc__cn_assoc_pop_call(). This situation occurs
 * 	                       when called from cancel_calls_action_rtn().
 * 	                     - Add local variable "assoc" to use with
 * 	                       rpc__cn_assoc_dealloc().
 * 	                     - Add call_rep arg to rpc__cn_assoc_pop_call().
 * 	[1992/10/13  20:46:05  weisman]
 * 
 * Revision 1.1.3.4  1992/08/07  16:34:58  rec
 * 	      5-aug-92    wh      Free the protocol trailer in call_end only
 * 	                          if it exists.  It would not exist on the
 * 	                          server side if it's a maybe call.
 * 	[1992/08/07  16:01:23  rec]
 * 
 * Revision 1.1.3.3  1992/05/22  18:57:17  wei_hu
 * 	12-apr-91    sp      Fix RPC_CN_AUTH_CVT_ID* invocations
 * 	17-dec-91    ko      Bug fix for binding serialization. Check
 * 	                     if thread resolving binding before allowing
 * 	                     call to proceed.
 * 	[1992/05/22  18:42:37  wei_hu]
 * 
 * Revision 1.1  1992/01/19  03:09:15  devrcs
 * 	Initial revision
 * 
 * $EndLog$
 */
...
#endif
{
    ...
    {
	rpc_binding_handle_t h = (rpc_binding_handle_t) binding_r;

        /*
         * The binding has an auth info structure hanging off it,
         * which indicates this call is to be authenticated.
         */
        RPC_CN_AUTH_CRED_REFRESH (binding_r->auth_info, h, st);
        if (*st != rpc_s_ok)
        {
            return (NULL);
        }
    ...
    /*
     * Ideally, this checking should be in rpc_call_start(). However, since
     * CN doesn't support a single thread client, it makes a process
     * threaded.
     *
     * Note: rpc_g_is_single_threaded is protected by the runtime's global
     * mutex, which happen to be CN's global mutex. If CN starts using its
     * own global mutex, we need to lock the runtime's global mutex.
     */
	...
	*st = rpc_s_no_memory;
    ...
    if (*st == rpc_s_ok)
    {
		...
		*st = rpc_s_no_memory;
         ...
         */
	/*
	 * [1996/06/20  03:02:17  sommerfeld]
	 * ts->id not initialized, so not copied..
	 */
        transfer_syntax->index = call_rep->transfer_syntax.index;
        transfer_syntax->convert_epv = call_rep->transfer_syntax.convert_epv;	
    }
    else
    {
        /*
...
**  OUTPUTS:
**
**      out_call_args   A buffer containing marshaled RPC ouput
**                      arguments.
           ...
           (!has_timed_out))
    {
        TRY
        {
            ...
            else
            {
                ...
                pthread_get_expiration_np ((struct timespec *) &zero_delta, 
...
#endif
{
    ...
    if ((*st = call_r->cn_call_status) == rpc_s_ok)
    {
        ...
        if ((!call_r->u.client.cancel.timer_running) &&
            (call_r->u.client.cancel.timeout_time != rpc_c_cancel_infinite_timeout))
        {
            RPC_DBG_PRINTF (rpc_e_dbg_cancel, RPC_C_CN_DBG_CANCEL,

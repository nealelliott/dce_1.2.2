 ...
 * Revision 1.1.4.2  1996/02/18  00:32:24  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  23:17:57  marty]
 *
 * Revision 1.1.4.1  1995/12/11  19:48:48  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  19:25:28  root]
 * 
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  18:16:46  root]
 * 
 * Revision 1.1.2.2  1994/09/23  19:39:01  mori_m
 * 	CR 11041/11044: New test for varying array operation.
 * 	[1994/09/23  18:30:39  mori_m]
 * 
 * $EndLog$
 */
...
void client()
{
	...
	mtet_infoline("test case (cs_byte client_method_conf_vary_array)\n");
	...
	while (rpc_num <= 4)
	{
		...
		temp_status = cs_conf_vary_trans(bind_handle, SIZE, (long)length + 1, net_string, loc_string);

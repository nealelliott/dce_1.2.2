...
/*
 * HISTORY
 * $Log: tags_copy_fixed.c,v $
 * Revision 1.1.4.2  1996/02/18  00:33:39  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  23:18:56  marty]
 *
 * Revision 1.1.4.1  1995/12/11  19:51:04  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  19:26:17  root]
 * 
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  18:17:39  root]
 * 
 * Revision 1.1.2.2  1994/09/23  18:55:59  mori_m
 * 	Fix comment leader
 * 	[1994/09/23  18:51:04  mori_m]
 * 
 * 	CR 11041/11044: New test for binding copy operation.
 * 	[1994/09/23  18:34:47  mori_m]
 * 
 * $EndLog$
 */
...
client(void)
{
	...
	rpc_binding_handle_t	new_bind_handle;
	...
	mtet_infoline("test case (wchar_t client_tags_copy_fixed_array)\n");
	...
	rpc_binding_copy(bind_handle, &new_bind_handle, &temp_status);
	CHECK_STATUS(TRUE, "rpc_binding_copy", temp_status, rpc_s_ok);
	...
	fp_out = fopen("./i18n_tags_copy_fixed_result_file", "w");
	...
	while (!feof(fp_in))
	{
		...
		temp_status = cs_fixed_trans(new_bind_handle, net_string, loc_string);

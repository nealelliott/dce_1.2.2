...
/*
 * HISTORY
 * $Log: tags_conf_vary_cmir.c,v $
 * Revision 1.1.4.2  1996/02/18  00:32:52  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  23:18:20  marty]
 *
 * Revision 1.1.4.1  1995/12/11  19:49:41  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  19:25:47  root]
 * 
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  18:17:06  root]
 * 
 * Revision 1.1.2.2  1994/09/23  19:43:37  mori_m
 * 	CR 11041/11044: New test for varying array operation.
 * 	[1994/09/23  18:31:47  mori_m]
 * 
 * $EndLog$
 */
...
client(void)
{
	...
	mtet_infoline("test case (cs_byte client_tags_conf_vary_array_cmir)\n");
	...
	fp_out = fopen("./i18n_tags_conf_vary_cmir_result_file", "w");
	...
	while (rpc_num <= 4)
	{
		...
		length = strlen((char *)net_string);

		temp_status = cs_conf_vary_trans(bind_handle, SIZE, length + 1, net_string, loc_string);

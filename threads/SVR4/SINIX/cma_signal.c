 ...
 * HISTORY
 * $Log: cma_signal.c,v $
 * Revision 1.1.5.2  1996/02/17  23:33:22  marty
 * 	Update OSF copyright year
 * 	[1996/02/17  22:49:36  marty]
 *
 * Revision 1.1.5.1  1995/12/07  21:54:35  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/07  21:02:45  root]
 * 
 * Revision 1.1.2.2  1994/06/09  13:36:28  devsrc
 * 	 CR10892 - fix copyright in file
 * 	[1994/06/09  13:26:45  devsrc]
 * 
 ...
 * 
 * Revision 1.1.3.5  1992/08/28  14:12:45  bolinger
 * 	Bring forward IBM integration changes to BL10 sources.
 * 
 * Revision 1.1.3.4  1992/08/26  14:08:53  bolinger
 * 	Bring forward fix from IBM integration of BL10 sources.
 * 
 * Revision 1.1.3.3  1992/08/11  21:05:16  bolinger
 * 	Merge up to BL10+ internal release from DEC.
 * 
 * Revision 1.1.3.2  1992/08/10  16:10:55  bolinger
 ...
 * 
 * Revision 1.1.3.9  1992/06/23  21:03:05  bolinger
 ...
 * 
 * Revision 1.1.3.4  1992/04/20  18:13:31  bolinger
 ...
 * 
 * Revision 1.1.3.3  1992/04/14  14:35:51  mishkin
 * 	     Check to see if SIGLOST is defined before using it (APOLLO68K).
 * 	[1992/04/13  18:30:13  mishkin]
 * 
 * Revision 1.1.3.2  1992/04/08  18:05:55  bolinger
...
cma_sigwait(
	...
	if (sigismember (set, i)) {
		...
		if (__r_sigaction (i, &act, &sig_oact[i]) == -1)  
...
cma__abort_process(
	...
	/*
	*	FIX-ME:
	*		There is a bug in the BSD compatibility library on SVR4
	*	where signal(2) will not deinstall a signal handler
	*	installed by sigaction(2).  
	*		Therefore, use sigaction(2) to deinstall the handler.
	*/
	...
	if ( __r_sigaction( abort_signal, &act, (struct sigaction *)NULL ) == -1 )
		{
		cma__abort();
		}
    /*
...
# endif
	...
	if (i == cma__c_timer_signal) {
	    ...
	    if (__r_sigaction (i, &act, cma_c_null_ptr) == -1)
		cma__bugcheck ("init_signal:46");
	    act.sa_flags &= ~SA_RESTART;
...
# endif
		...
		if (__r_sigaction (i,&act,(struct sigaction *)cma_c_null_ptr) == -1)

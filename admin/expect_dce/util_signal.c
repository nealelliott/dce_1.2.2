 ...
 * HISTORY
 * $Log: util_signal.c,v $
 * Revision 1.1.2.1  1996/10/04  14:33:43  arvind
 * 	OSF DCE 1.2.2 Drop 4
 * 	[1996/10/04  14:33:13  arvind]
 *
 * $EndLog$
 */
 ...
 * implied warranty.
 *-----------------------------------------------------------------------------
 * $Id: util_signal.c,v 1.1.2.1 1996/10/04 14:33:43 arvind Exp $
 *-----------------------------------------------------------------------------
 */
    ...
    int         signalNum;
{
	...
	sprintf (errorInfo, "\n    while executing signal trap code for %s%s",
                 i18n_result? "UNKNOWN" : i18n_signal_name, " signal");
    ...
    int         signalNum;
{
	...
	if (i18n_result)
		free(signalName);
        Tcl_AppendResult (interp, i18n_result? "UNKNOWN" : signalName,
                          " signal received", (char *)NULL);

 ...
 * HISTORY
 * $Log: rodpat04.c,v $
 * Revision 1.1.4.2  1996/03/11  13:21:47  marty
 * 	Update OSF copyright years
 * 	[1996/03/11  13:10:31  marty]
 *
 * Revision 1.1.4.1  1995/12/08  17:38:36  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/08  16:21:11  root]
 * 
 * Revision 1.1.2.3  1994/06/10  21:08:43  devsrc
 * 	cr10871 - fix copyright
 * 	[1994/06/10  14:51:42  devsrc]
 * 
 * Revision 1.1.2.2  1994/05/10  16:01:03  marrek
 * 	April 1994 code submission.
 * 	[1994/04/27  13:00:18  marrek]
 * 
 * Revision 1.1.2.1  1994/03/23  15:37:31  keutel
 * 	creation
 * 	[1994/03/21  13:29:26  keutel]
 * 
 * $EndLog$
 */
#if !defined(lint) && defined(GDS_RCS_ID)
static char rcsid[] = { "@(#) $RCSfile: rodpat04.c,v $ $Revision: 1.1.4.2 $ $Date: 1996/03/11 13:21:47 $" } ;
#endif
...
static char *sccsid = "@(#)rodpat04.c  1.2  93/12/20";

/*  vinita - to link Ros only    */

#ifdef RC0041_LuRosOnly
...
/* ****************** Osi stack type 1 (SPM, PPM, AC-PM ************* */
/* ****************** RO-PM)				************* */
...
/* for debugging vp ro1410_SendReceive */
   case RC0213_Transport    : rc = ro0310_SendReceive (pmcxt); break;
/* for debugging vp ro1410_SendReceive */
   case RC0214_Session	    : rc = ro0310_SendReceive (pmcxt); break;
/* for debugging vp  rc = ro0800_Spm */
...
/*  fo debugging vp rc = ro1499_CleanUp (event, p1Pmcxt, p2, p3, p4); */
			      break;
   case RC0213_Transport    : rc = ro0399_CleanUp (event, p1Pmcxt, p2, p3, p4);
/*  fo debugging vp rc = ro1499_CleanUp (event, p1Pmcxt, p2, p3, p4); */
			      break;
   case RC0214_Session	    : rc = -R_NCLFCT; 
/* rc = ro0801_CleanUp (event, p1Pmcxt, p2, p3, p4); for debugging vp */
			      break;
...
switch (pmNo) {
   ...
   case RC0202_Lower	    : rc = ro0302_informSpm (pmCxt, inNo, info); break;
   case RC0213_Transport    : rc = -R_NIFFCT;				 break;
   case RC0214_Session	    : rc = ro0302_informSpm (pmCxt, inNo, info); break;
...
RM0003_RETURN (rs0297, signed short int, -R_N410DE)
}/*end*/

/*exon ****************************************************************/
/*                                                                    */
...
switch (pmNo) {
 ...
 case RC0219_Rose    : rc = -R_NPDVEN;

/* for debugging vp      rc = ro070a_encodSniPRopm (defBy, tSyNa, store, pcxt, pdvN, len); */
      break;
...
switch (pmNo) {
 ...
 case RC0219_Rose    : rc = -R_NPDVDE;
/*      rc = ro070b_decodSniPRopm (absId,chTag,defBy,tSyNa,store,pcxt,pdvN,len);
for debugging vp */ 
     break;

 case RC0221_RoseUser:
      rc = ro1507_decodSniPUpperCtrl (psAbsId, store,
  				      pcxt,pdvN);
      break;

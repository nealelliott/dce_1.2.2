...
/*
 * HISTORY
 * $Log: tags_conf_smir.c,v $
 * Revision 1.1.4.2  1996/02/18  00:33:30  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  23:18:49  marty]
 *
 * Revision 1.1.4.1  1995/12/11  19:50:48  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  19:26:12  root]
 * 
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  18:17:33  root]
 * 
 * Revision 1.1.2.1  1994/09/27  18:47:34  mori_m
 * 	CR 11041:  New test for conformant array ops.
 * 	[1994/09/27  18:38:03  mori_m]
 * 
 * $EndLog$
 */
...
client(void)
{
	...
	mtet_infoline("test case (wchar_t client_tags_conf_array_smir)\n");
	...
	fp_out = fopen("./i18n_tags_conf_smir_result_file", "w");

 ...
 * HISTORY
 * $Log: ndsreg.c,v $
 * Revision 1.1.4.2  1996/02/18  18:20:24  marty
 * 	Update OSF copyright years
 * 	[1996/02/18  17:43:02  marty]
 *
 * Revision 1.1.4.1  1995/12/08  16:06:15  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/08  15:16:29  root]
 * 
 * Revision 1.1.2.6  1994/09/06  12:25:52  keutel
 * 	line 1 directive removed: OT 11971
 * 	[1994/09/06  11:17:16  keutel]
 * 
 * Revision 1.1.2.5  1994/07/06  15:07:53  marrek
 * 	July 1994 code submission.
 * 	[1994/07/04  13:17:48  marrek]
 * 
 * Revision 1.1.2.4  1994/06/21  14:47:42  marrek
 * 	June 1994 code submission.
 * 	[1994/06/16  09:42:57  marrek]
 * 
 * Revision 1.1.2.3  1994/06/09  18:46:58  devsrc
 * 	cr10871 - expand copyright
 * 	[1994/06/09  18:20:05  devsrc]
 * 
 * Revision 1.1.2.2  1994/05/10  15:57:17  marrek
 * 	Bug fixes.
 * 	[1994/04/29  12:36:37  marrek]
 * 
 * 	April 1994 code submission.
 * 	[1994/04/27  12:42:49  marrek]
 * 
 * Revision 1.1.2.1  1994/03/23  15:26:11  keutel
 * 	creation
 * 	[1994/03/21  15:54:10  keutel]
 * 
 * $EndLog$
 */
#if !defined(lint) && defined(GDS_RCS_ID)
static char rcsid[] = "@(#)$RCSfile: ndsreg.c,v $ $Revision: 1.1.4.2 $ $Date: 1996/02/18 18:20:24 $";
#endif
...
signed32 nds_regex (byte	*compexpr,	/* > compiled RE info */
    ...
    if (((regex_t *) compexpr)->buffer == (unsigned char *) NULL)
	((regex_t *) compexpr)->buffer =
				  (unsigned char *) ((regex_t *) compexpr + 1) ;

 ...
 * HISTORY
 * $Log: method_vary.c,v $
 * Revision 1.1.4.2  1996/02/18  00:33:22  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  23:18:42  marty]
 *
 * Revision 1.1.4.1  1995/12/11  19:50:36  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  19:26:06  root]
 * 
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  18:17:27  root]
 * 
 * Revision 1.1.2.2  1994/09/23  19:30:51  mori_m
 * 	CR 11041/11044: New test for varying array operation.
 * 	[1994/09/23  18:34:29  mori_m]
 * 
 * $EndLog$
 */
...
void client()
{
	...
	mtet_infoline("test case (wchar_t client_method_vary_array)\n");
	...
	while (rpc_num <= 4)
	{
		...
		temp_status = cs_vary_trans(bind_handle, (long)w_len + 1, net_string, loc_string);

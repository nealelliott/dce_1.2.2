 ...
 * HISTORY
 * $Log: roacpmzz.c,v $
 * Revision 1.1.4.2  1996/02/18  18:21:21  marty
 * 	Update OSF copyright years
 * 	[1996/02/18  17:44:07  marty]
 *
 * Revision 1.1.4.1  1995/12/08  16:08:01  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/08  15:17:33  root]
 * 
 * Revision 1.1.2.3  1994/06/09  18:47:29  devsrc
 * 	cr10871 - expand copyright
 * 	[1994/06/09  18:20:46  devsrc]
 * 
 * Revision 1.1.2.2  1994/05/10  15:57:42  marrek
 * 	April 1994 code submission.
 * 	[1994/04/27  12:45:06  marrek]
 * 
 * Revision 1.1.2.1  1994/03/23  15:29:29  keutel
 * 	creation
 * 	[1994/03/21  13:14:47  keutel]
 * 
 * $EndLog$
 */
#if !defined(lint) && defined(GDS_RCS_ID)
static char rcsid[] = { "@(#) $RCSfile: roacpmzz.c,v $ $Revision: 1.1.4.2 $ $Date: 1996/02/18 18:21:21 $" } ;
#endif
...
static char *sccsid =    "@(#) roacpmzz.c 1.1 93/11/29   RTS-V2.00"; 
...
asn1_pvoid pContext)
{
  ...
  if (sterr == OK) /* sterr 2*/
	...
	if( RTS_External_match(matchz))
	  {
	  sterr=RTS_External_dec(hdl,poszm,&pNode[I_0],pContext);
	  }
	else
	  {
...
asn1_pvoid pContext)
{
  ...
  if (asn1_m == -1)
    ...
    for (I_0=0; I_0 < *NumOfExt; I_0++)
      {
      RTS_External_cod(hdl,-1,0,&pNode[I_0],pContext);
      }
    asn1st_deflencod(hdl, posz0);
    }
  return(ro0063_sterror(hdl));

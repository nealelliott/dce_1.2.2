 ...
 * HISTORY
 * $Log: dgslsn.c,v $
 * Revision 1.1.926.2  1996/02/18  00:04:06  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  22:56:30  marty]
 *
 * Revision 1.1.926.1  1995/12/08  00:20:20  root
 * 	Submit OSF/DCE 1.2.1
 * 
 * 	HP revision /main/HPDCE02/jrr_1.2_mothra/1  1995/11/16  21:33 UTC  jrr
 * 	Remove Mothra specific code
 * 
 * 	HP revision /main/HPDCE02/5  1995/10/18  15:18 UTC  jss
 * 	Merge fix for CHFts257.
 * 
 * 	HP revision /main/HPDCE02/jss_dced_acl/2  1995/10/18  14:56 UTC  jss
 * 	Fix for CHFts16257. Use the defined constant for maximum refcnt.
 * 
 * 	HP revision /main/HPDCE02/jss_dced_acl/1  1995/10/17  20:49 UTC  jss
 * 	Fix for CHFts16257. The scte refcnt may overflow if too many maybe
 * 	calls have been queued up. If the refcnt becomes too large, start
 * 	dropping the maybe calls.
 * 
 * 	HP revision /main/HPDCE02/4  1995/07/14  19:06 UTC  tatsu_s
 * 	Submitted the fix for CHFts15608.
 * 
 * 	HP revision /main/HPDCE02/tatsu_s.local_rpc.b4/1  1995/07/06  21:06 UTC  tatsu_s
 * 	Update the client handle's timestamp upon receipt of request.
 * 
 * 	HP revision /main/HPDCE02/3  1995/06/15  20:14 UTC  tatsu_s
 * 	Submitted the fix for CHFts15498.
 * 
 * 	HP revision /main/HPDCE02/tatsu_s.svc.b0/2  1995/06/13  19:01 UTC  tatsu_s
 * 	Cleaned up the socket allocation.
 * 
 * 	HP revision /main/HPDCE02/tatsu_s.svc.b0/1  1995/06/12  19:02 UTC  tatsu_s
 ...
 * 
 * 	HP revision /main/markar_local_rpc/2  1995/01/16  14:21 UTC  markar
 * 	handle case where alloc_socket fails
 * 
 * 	HP revision /main/markar_local_rpc/1  1995/01/05  22:01 UTC  markar
 * 	Implementing Local RPC bypass mechanism
 * 	[1995/12/07  23:59:19  root]
 * 
 * Revision 1.1.922.4  1994/08/25  21:54:19  tatsu_s
 * 	MBF: Always make the max pkt reservation.
 * 	[1994/08/24  19:06:08  tatsu_s]
 * 
 * Revision 1.1.922.3  1994/06/21  21:54:04  hopkins
 * 	Merge up to DCE1_1.
 * 	[1994/06/08  21:32:09  hopkins]
 * 
 * 	More serviceability
 * 	[1994/06/06  21:13:13  hopkins]
 * 
 * Revision 1.1.922.2  1994/05/27  15:36:35  tatsu_s
 * 	Don't use RPC_DG_FRAG_SIZE_TO_NUM_PKTS()
 * 	for RPC_C_DG_MAX_FRAG_SIZE and RPC_C_DG_MUST_RECV_FRAG_SIZE.
 * 	[1994/05/19  20:24:37  tatsu_s]
 * 
 * 	DG multi-buffer fragments.
 * 	[1994/04/29  19:18:46  tatsu_s]
 * 
 * Revision 1.1.922.1  1994/01/21  22:37:23  cbrooks
 * 	RPC Code Cleanyp - Initial Submission
 * 	[1994/01/21  21:57:37  cbrooks]
 * 
 * Revision 1.1.8.1  1993/10/04  18:18:30  markar
 * 	     OT CR 1236 fix: Make back-to-back maybe calls work.
 * 	[1993/09/30  13:40:13  markar]
 * 
 * Revision 1.1.6.7  1993/01/13  18:05:51  mishkin
 * 	Merge Sommerfeld's changes.
 * 	[1992/12/22  15:51:03  mishkin]
 * 
 * 	Send no-calls with fack body in response to pings in the receive state.
 * 	[1992/12/11  22:06:22  mishkin]
 * 
 * Revision 1.1.6.6  1993/01/03  23:24:54  bbelch
 * 	Embedding copyright notice
 * 	[1993/01/03  20:06:22  bbelch]
 * 
 * Revision 1.1.6.5  1992/12/23  20:49:44  zeliff
 * 	Embedding copyright notice
 * 	[1992/12/23  15:38:07  zeliff]
 * 
 * Revision 1.1.6.4  1992/12/21  21:31:05  sommerfeld
 * 	Merge in old dusty conv_threada branch with minor modifications.
 * 	[1992/12/03  18:45:26  sommerfeld]
 * 
 * Revision 1.1.6.3  1992/10/13  20:55:08  weisman
 * 	Submit Wei Hu CN deadlock fixes/OT 5143
 * 
 * 	      13-oct-92 magid    Rename rpc__dg_server_chk_and_set_sboot ->
 * 	                         rpc__dg_svr_chk_and_set_sboot
 * 	[1992/10/13  20:47:43  weisman]
 * 
 * Revision 1.1.6.2  1992/10/02  19:52:11  markar
 * 	 OT CR 5501 fixes: plugged rqe leak, cleaned up callback path
 * 	[1992/09/30  18:27:24  markar]
 * 
 * Revision 1.1.3.3  1992/05/12  16:19:20  mishkin
 * 	bmerge rationing from mainline
 * 	[1992/05/08  21:21:04  mishkin]
 * 
 * 	- RPC_DG_SLSN_CHK_AND_SET_SBOOT macro -> rpc__dg_svr_chk_and_set_sboot
 * 	           function.
 * 	- RPC_DG_SCT_INQ_SCALL -> rpc__dg_sct_inq_scall.
 * 	- RPC_DG_SCT_NEW_CALL -> rpc__dg_sct_new_call.
 * 	- RPC_DG_SCT_BACKOUT_NEW_CALL -> rpc__dg_sct_backout_new_call.
 * 	- RPC_DG_CCALL_LSCT_NEW_CALL -> rpc_dg_ccall_lsct_new_call
 * 	[1992/05/08  12:49:07  mishkin]
 * 
 * Revision 1.1.3.2  1992/05/07  19:55:43  markar
 * 	 06-may-92 markar   packet rationing mods
 * 	[1992/05/07  15:37:44  markar]
 * 
 * Revision 1.1  1992/01/19  03:10:26  devrcs
 * 	Initial revision
 * 
 * $EndLog$
 */
...
#endif
{
	...
	/*
	 * The scte refcnt may overflow if too many "maybe" calls have been queued
         * up. If the refcnt becomes too large, start dropping the maybe calls.
	 */
	if (scte->refcnt > (RPC_DG_SCT_REFCNT_MAX - 5)) {
	    RPC_DBG_GPRINTF(("(rpc__dg_do_request) scte->refcnt overflow. Dropping \"maybe\" call.\n"));
    ...
    /*
     * A "request" is as good as INDY.
     */
    if (scall->scte != NULL && scall->scte->client != NULL)
    {
	scall->scte->client->last_update = scall->c.last_rcv_timestamp;
    }

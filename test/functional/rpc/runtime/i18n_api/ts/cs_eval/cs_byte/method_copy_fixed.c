...
/*
 * HISTORY
 * $Log: method_copy_fixed.c,v $
 * Revision 1.1.4.2  1996/02/18  00:32:28  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  23:18:01  marty]
 *
 * Revision 1.1.4.1  1995/12/11  19:48:58  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  19:25:30  root]
 * 
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  18:16:49  root]
 * 
 * Revision 1.1.2.1  1994/08/02  20:06:53  mori_m
 * 	CR 9701:  Testing rpc_binding_copy() with code sets i14y.
 * 	[1994/08/02  20:01:32  mori_m]
 * 
 * $EndLog$
 */
...
client()
{
	...
	mtet_infoline("test case (cs_byte client_method_copy_fixed_array)\n");
	...
	fp_out = fopen("./i18n_method_copy_fixed_result_file", "w");

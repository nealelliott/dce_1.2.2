...
/*
 * HISTORY
 * $Log: dcdrel001b_server.c,v $
 * Revision 1.1.4.2  1996/02/17  23:26:45  marty
 * 	Update OSF copyright year
 * 	[1996/02/17  22:44:27  marty]
 *
 * Revision 1.1.4.1  1995/12/11  21:55:34  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  20:55:33  root]
 * 
 * Revision 1.1.2.1  1994/07/21  21:27:18  fadden
 * 	Initial version after renaming
 * 	[1994/07/21  20:37:45  fadden]
 * 
 * $EndLog$
 */
/* 
 ...
 * ABSTRACT
 *
 *   This module provides the server main routine for a server which
 *   registers its endpoints using the dced API.
 *
 */
...
boolean32
dcdrel001b_authzn(rpc_binding_handle_t h, unsigned32 m, error_status_t *st);
...
main(int argc, char **argv)
{
    ...
    sprintf(srv_name, "/.:/%s/dcdrel001b", myhost);
    free(myhost);
    ...
    server_setup(srv_name, 
		 grp_name,
		 dcdrel001b_v1_0_s_ifspec, 
		 &server_obj_uuid,
		 (unsigned_char_t *)"DCDREL001b Server",
		 dcdrel001b_authzn,
	         &bind_vec,
		 &st);

 ...
 * HISTORY
 * $Log: ndrui5.c,v $
 * Revision 1.1.11.2  1996/02/17  23:58:10  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  22:52:36  marty]
 *
 * Revision 1.1.11.1  1995/12/07  22:31:09  root
 * 	Submit OSF/DCE 1.2.1
 * 
 * 	HP revision /main/dat_xidl2/1  1995/11/17  17:08 UTC  dat
 * 	Merge second XIDL drop for DCE 1.2.1
 * 	[1995/12/07  21:16:15  root]
 * 
 * Revision 1.1.2.1  1995/10/23  01:49:37  bfc
 * 	oct 95 idl drop
 * 	[1995/10/22  23:36:22  bfc]
 * 
 * 	may 95 idl drop
 * 	[1995/10/22  22:58:05  bfc]
 * 
 * 	DCE for DEC OSF/1: populate from OSF DCE R1.1
 * 	[1995/10/21  18:26:02  bfc]
 * 
 * Revision 1.1.6.3  1994/08/23  20:19:06  tom
 * 	Bug 10410 - Return new exception (rpc_x_ss_codeset_conv_error)
 * 	instead of rpc_x_ss_pipe_comm_error when codeset conversion fails
 * 	in the server stub.
 * 	[1994/08/23  20:17:17  tom]
 * 
 * Revision 1.1.6.2  1994/07/13  18:56:30  tom
 * 	Bug 10103 - Reduce little-endian bias of stubs
 * 	[1994/07/12  18:49:45  tom]
 * 
 * Revision 1.1.6.1  1994/05/04  21:56:20  mori_m
 * 	CR 10496: Set wire length to l_data_len, if 'convert_type' is
 * 		  'idl_cs_no_convert' for I-char unmarshalling.
 * 	[1994/05/04  21:00:32  mori_m]
 * 
 * Revision 1.1.2.2  1993/07/07  20:10:13  ganni
 * 	reduced stub idl sources
 * 	[1993/07/07  19:38:57  ganni]
 * 
 * $EndLog$
 */
/*
...
#endif
{
        ...
        || (array_type == IDL_DT_OPEN_ARRAY))
    {
        ...
        ln_index--;
        IDL_UNMAR_ULONG(&range_data.lower);     /* A-value */
            ...
            switch(type_byte)
            {
                case IDL_DT_CS_ATTRIBUTE:
                    ...
                    rpc_ss_put_typed_integer(
                        ...
                        *type_vec_ptr,
                        IDL_msp->IDL_param_vec[param_index], IDL_msp);
...
#endif
{
        ...
        || (array_type == IDL_DT_OPEN_ARRAY))
    {
        ...
        rpc_ss_ndr_conf_cs_array_param(
...
#endif
{
    ...
    rpc_ss_put_typed_integer(l_storage_len, sz_type,
                       (rpc_void_p_t)&cs_shadow[szp_index-1].IDL_data, IDL_msp);

 ...
 * HISTORY
 * $Log: manager3.c,v $
 * Revision 1.1.4.2  1996/02/17  23:28:33  marty
 * 	Update OSF copyright year
 * 	[1996/02/17  22:45:31  marty]
 *
 * Revision 1.1.4.1  1995/12/11  22:45:38  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  22:21:41  root]
 * 
 * Revision 1.1.2.2  1994/10/06  20:43:42  agd
 * 	expand copyright
 * 	[1994/10/06  14:32:01  agd]
 * 
 * Revision 1.1.2.1  1994/09/19  18:18:02  bhaim
 * 	multidelegate test
 * 	[1994/09/19  17:51:04  bhaim]
 * 
 * $EndLog$
 */
/*
...
#define IFSPEC_IN         string_conv3_v1_0_s_ifspec
#define IFSPEC_OUT        string_conv4_v1_0_s_ifspec
#define INTERFACE_NUMBER  conv_3_interface_number
...
void string_convert_uppercase3
(
...
/******/
   ...
   if (num_requested > INTERFACE_NUMBER)
   {
      ...
      sprintf(cds_entry_name, "/.:/subsys/HP/sample-apps/string-convert4");
    ...
    rpc_binding_set_auth_info (
          newbh,
          (unsigned char *)string_conv4_SERVER_PRINCIPAL_NAME,  /* from real-common.h */
      ...
      PRINT_FUNC(PRINT_HANDLE, "Calling string_convert_uppercase4(%s), servers(%s)\n",
		 conv_string, num_serv);

      string_convert_uppercase4(newbh, conv_string, num_serv, auth_status);

      PRINT_FUNC(PRINT_HANDLE, "string_convert_uppercase4 returned \"%s\"\n",
		 conv_string);
   ...
   else
   {
       ...
       */
      PRINT_FUNC(PRINT_HANDLE, ">>> string_convert_uppercase3(%s), servers(%s)\n",
                 conv_string, num_serv);

 ...
 * HISTORY
 * $Log: main.c,v $
 * Revision 1.1.7.2  1996/02/17  23:20:42  marty
 * 	Update OSF copyright year
 * 	[1996/02/17  22:39:30  marty]
 *
 * Revision 1.1.7.1  1995/12/11  20:05:31  root
 ...
 * 	[1995/12/11  19:43:27  root]
 * 
 * Revision 1.1.5.5  1993/01/25  18:04:54  bbelch
 * 	Fix duplicate log
 * 	[1993/01/25  17:36:55  bbelch]
 * 
 * Revision 1.1.5.4  1993/01/11  22:14:54  bbelch
 * 	Embedding copyright notice
 * 	[1993/01/06  18:07:04  bbelch]
 * 
 * Revision 1.1.5.3  1992/11/23  14:42:11  cuti
 * 	Modify dce_error_inq_text auguments.
 * 	[1992/11/23  14:35:19  cuti]
 * 
...
#ifdef DEBUG 
printf("-------------------------------------------\nTSHStatus:\n\nInput args are\n");
printf("    Program Name = %s, mask = %lx, level = %lx, AStatus (%lx) should = EStatus (%lx)\n    .%s.\n",
 ...
 */
	...
	sprintf(buf, "AStatus (0x%08x) should = EStatus (0x%08x)\n",
		AStatus, EStatus);

	TSHMessage(ctx, MOFAILURE, buf);
    }

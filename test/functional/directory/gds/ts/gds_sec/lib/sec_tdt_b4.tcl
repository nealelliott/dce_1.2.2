...
# 
# HISTORY
# $Log: sec_tdt_b4.tcl,v $
# Revision 1.1.4.2  1996/03/11  02:34:54  marty
# 	Update OSF copyright years
# 	[1996/03/10  19:40:17  marty]
#
# Revision 1.1.4.1  1995/12/11  15:25:33  root
# 	Submit
# 	[1995/12/11  14:36:04  root]
# 
# Revision 1.1.2.1  1994/07/06  15:11:03  marrek
# 	Created in July 1994 code drop.
# 	[1994/07/06  13:02:44  marrek]
# 
# $EndLog$
#
# $RCSfile: sec_tdt_b4.tcl,v $ $Revision: 1.1.4.2 $ $Date: 1996/03/11 02:34:54 $
#
#######################################################################
#    FILE : sec_tdt_b4.tcl                                            #
#    TYPE : gdscp script                                              #
...
if {[catch {eval "modify /C=re/O=sni/OU=ap2/CN=two -changeattr UP=secret2 UP=secret"} message] == 0 } {
	puts "UNEXPECTED: Modify protected attr succeeded" 
	} else {
	puts $message
	puts "EXPECTED : Modify protected attr failed"
	}

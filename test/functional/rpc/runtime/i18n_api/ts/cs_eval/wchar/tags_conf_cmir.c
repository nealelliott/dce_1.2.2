...
/*
 * HISTORY
 * $Log: tags_conf_cmir.c,v $
 * Revision 1.1.4.2  1996/02/18  00:33:28  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  23:18:47  marty]
 *
 * Revision 1.1.4.1  1995/12/11  19:50:45  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  19:26:10  root]
 * 
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  18:17:32  root]
 * 
 * Revision 1.1.2.1  1994/09/27  18:47:33  mori_m
 * 	CR 11041:  New test for conformant array ops.
 * 	[1994/09/27  18:37:45  mori_m]
 * 
 * $EndLog$
 */
...
client(void)
{
	...
	mtet_infoline("test case (wchar_t client_tags_conf_array_cmir)\n");
	...
	fp_out = fopen("./i18n_tags_conf_cmir_result_file", "w");

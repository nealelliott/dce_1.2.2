 ...
 * HISTORY
 * $Log: rodpat02.c,v $
 * Revision 1.1.4.2  1996/03/11  13:21:44  marty
 * 	Update OSF copyright years
 * 	[1996/03/11  13:10:28  marty]
 *
 * Revision 1.1.4.1  1995/12/08  17:38:25  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/08  16:21:06  root]
 * 
 * Revision 1.1.2.3  1994/06/10  21:08:34  devsrc
 * 	cr10871 - fix copyright
 * 	[1994/06/10  14:51:38  devsrc]
 * 
 * Revision 1.1.2.2  1994/05/10  16:01:01  marrek
 * 	April 1994 code submission.
 * 	[1994/04/27  13:00:01  marrek]
 * 
 * Revision 1.1.2.1  1994/03/23  15:37:25  keutel
 * 	creation
 * 	[1994/03/21  13:29:12  keutel]
 * 
 * $EndLog$
 */
#if !defined(lint) && defined(GDS_RCS_ID)
static char rcsid[] = { "@(#) $RCSfile: rodpat02.c,v $ $Revision: 1.1.4.2 $ $Date: 1996/03/11 13:21:44 $" } ;
#endif
...
static char *sccsid = "@(#)rodpat02.c  1.2  93/12/20";
...
switch (pmNo) {
   ...
   case RC0213_Transport    : rc = ro0399_cleanUp (event, p1Pmcxt, p2, p3, p4);
			      break;
   case RC0214_Session	    : rc = ro0399_cleanUp (event, p1Pmcxt, p2, p3, p4);
			      break;

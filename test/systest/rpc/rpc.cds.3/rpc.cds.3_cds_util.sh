...
# 
# HISTORY
# $Log: rpc.cds.3_cds_util.sh,v $
# Revision 1.1.7.2  1996/03/11  02:45:37  marty
# 	Update OSF copyright years
# 	[1996/03/10  20:08:01  marty]
#
# Revision 1.1.7.1  1995/12/11  22:42:36  root
# 	Submit OSF/DCE 1.2.1
# 	[1995/12/11  22:19:51  root]
# 
# Revision 1.1.4.1  1994/06/10  20:49:58  devsrc
# 	cr10872 - fixed copyright
# 	[1994/06/10  17:19:29  devsrc]
# 
# Revision 1.1.2.3  1993/03/12  18:55:28  mhickey
# 	Fixing bsubmit mystery meat
# 	[1993/03/12  18:50:45  mhickey]
# 
# Revision 1.1.1.2  1993/01/29  19:01:35  mhickey
# 	Initial check in for the rpc.cds.3 system test.
# 
# Revision 1.1.1.2  1992/12/03  15:39:35  mhickey
...
rpcsec2_cds_setacl()
{
   ...
   do
      ...
      then
         ...
         rs2_cs_aclstr_lst=$rs2_cs_aclstr
      else
         #
   ...
   #
   if [ "$rs2_cs_aclstr_lst" != "$rs2_cs_aclstr" ]
   then
      rs2_cs_aclstr="$rs2_cs_aclstr_lst"
   fi
   #
...
rpcsec2_cds_cnf_chkvars()
{
   ...
   #
   if [ ! -n "$RPCCDS3_SRV_CDS_NAME" ]
   then
      #
      # echo and set error flag
      #
      echo "No value defined for RPCCDS3_SRV_CDS_NAME..."
   ...
   #
   if [ ! -n "$RPCCDS3_SRV_CDS_DIR_ACL" ]
   then
      #
      # echo and set error flag
      #
      echo "No value defined for RPCCDS3_SRV_CDS_DIR_ACL..."
      rpcsec2_cds_cc_out="error"
   fi
}

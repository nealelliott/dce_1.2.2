...
FIRSTCPP =             
RC = rc
CFLAGS_D_DEXE = /nologo /G2 /Zp1 /Gy /W3 /Gf /Zi /AL /Od /D "_DEBUG" /D "_DOS" /D "JAPANESE" /FR /Fd"DNDIR.PDB"
...
DNDIR_DEP = c:\client\filer\cli_filr.h \
...
DNDIR.OBJ:	DNDIR.C $(DNDIR_DEP)
	$(CC) $(CFLAGS) $(CCREATEPCHFLAG) /c DNDIR.C

$(PROJ).EXE::	DNDIR.OBJ $(OBJS_EXT) $(DEFFILE)
	echo >NUL @<<$(PROJ).CRF
DNDIR.OBJ +
$(OBJS_EXT)
$(PROJ).EXE

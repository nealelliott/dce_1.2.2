...
FIRSTCPP =             
RC = rc
CFLAGS_D_DEXE = /nologo /Zr /G2 /Zp1 /Gy /W3 /Gf /Zi /AL /Od /D "_DEBUG" /D "JAPANESE" /D "_DOS" /FR /Fd"DRIGHT.PDB"
CFLAGS_R_DEXE = /nologo /Gs /G3 /Zp1 /Gy /W3 /Gf /AL /Ox /D "NDEBUG" /D "_DOS" /FR 
LFLAGS_D_DEXE = /NOLOGO /NOI /STACK:35000 /NOPACKF /ONERROR:NOEXE /CO /MAP /LINE
...
DRIGHT_DEP = c:\client\filer\cli_filr.h \
...
DRIGHT.OBJ:	DRIGHT.C $(DRIGHT_DEP)
	$(CC) $(CFLAGS) $(CCREATEPCHFLAG) /c DRIGHT.C

$(PROJ).EXE::	DRIGHT.OBJ $(OBJS_EXT) $(DEFFILE)
	echo >NUL @<<$(PROJ).CRF
DRIGHT.OBJ +
$(OBJS_EXT)
$(PROJ).EXE

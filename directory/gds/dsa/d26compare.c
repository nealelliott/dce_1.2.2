 ...
 * HISTORY
 * $Log: d26compare.c,v $
 * Revision 1.1.10.2  1996/02/18  19:44:53  marty
 * 	Update OSF copyright years
 * 	[1996/02/18  18:26:01  marty]
 *
 * Revision 1.1.10.1  1995/12/08  15:43:13  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/08  15:06:21  root]
 * 
 * Revision 1.1.8.2  1994/05/10  15:51:51  marrek
 * 	April 1994 code submission.
 * 	[1994/04/27  12:19:47  marrek]
 * 
 * Revision 1.1.8.1  1994/02/22  16:05:18  marrek
 * 	Code drop for dce1.1.
 * 	[1994/02/08  10:09:16  marrek]
 * 
 * Revision 1.1.6.2  1993/08/10  13:41:57  marrek
 * 	July 1993 code drop.
 * 	[1993/07/30  13:02:43  marrek]
 * 
 * Revision 1.1.4.3  1992/12/31  18:59:07  bbelch
 * 	Embedding copyright notice
 * 	[1992/12/31  13:18:30  bbelch]
 * 
 * Revision 1.1.4.2  1992/11/27  19:35:33  marrek
 * 	November 1992 code drop
 * 	[1992/11/20  11:04:39  marrek]
 * 
 * Revision 1.1.2.2  1992/06/01  23:46:00  zeliff
 * 	New version of file from GDS drop
 * 	[1992/05/28  20:53:37  zeliff]
 * 
 * $EndLog$
 */
#if !defined(lint) && defined(GDS_RCS_ID)
static char rcsid[] = "@(#)$RCSfile: d26compare.c,v $ $Revision: 1.1.10.2 $ $Date: 1996/02/18 19:44:53 $";
#endif
...
/*                                                                    */
/* DESCRIPTION  : The module contains the "compare" function of DSA   */
/*                                                                    */
...
/* TYPE         : C-FUNCTION                                          */
/*                                                                    */
/* NAME         : d26_6_compare         <compare>                     */
/*                                                                    */
/* AUTHOR       : Schmid, D AP 11                                     */
/* DATE         : 08.02.88                                            */
/*                                                                    */
/* DESCRIPTION  : This function will look whether the purported object*/
/*                (incl. filter) exists or not.                       */
...
{                                   /* d26_6_compare                  */
  ...
  static char *function = "d26_6_compare";
  ...
  unsigned16  *rep;                 /* pointer to representation      */
  ...
  {                         /*  set return_value and error_codes      */
    ...
    ret_value = D26_ERROR;
	 ...
	 ((s_i_apdu = (byte *)D27_MALLOC(svc_c_sev_warning,input_len +
	  sizeof(D23_srcharg) + sizeof(D23_rq_info) + sizeof(D23_ft1_info)
	  + sizeof(D23_fi1_info))) == NULL)
  {                             /*  set return_value and error_codes  */
    d27_010_set_error_apdu((D23_rserror *)*output,D2_TEMP_ERR,D2_REM_ERR,
      D2_UNWILLING,output_len);
    ret_value = D26_ERROR;
  ...
  {                         /*  build parameter block for DS_SEARCH   */
    ...
    *((D23_header *)message) = *((D23_header *)scan);
    ...
    ((D23_ft1_info *)message)->d23_fp1tag   = D23_PATTAG;
    ((D23_ft1_info *)message)->d23_fp1mod   = D2_ITEM;
    message += sizeof(D23_ft1_info);
				    /*  generate filter item          */
    ((D23_fi1_info *)message)->d23_fi1tag   = D23_FIITAG;
    ((D23_fi1_info *)message)->d23_fi1match = D2_EQUAL;
    rep = &(((D23_fi1_info *)message)->d23_fi1syntx);
    message += sizeof(D23_fi1_info);
				    /*  copy attribute type           */
    d26_c08_copy_attribute_type(&scan,&message);
    *rep  = ((D23_av_info *)scan)->d23_asyntx;
    scan += sizeof(D23_av_info);
				    /*  copy attribute value          */
    d26_c09_copy_attribute_value(&scan,&message);

    ((D23_eom *)message)->d23_eomtag = D23_EOMTAG;

				    /*  call internal search          */
    ret_value = d26_u00_search(FALSE,D23_COMPARE,s_i_apdu,output_len,output,
	...
	{               /*  do the chaining                           */
	  ret_value = d26_d01_chain_request(dap_message,input_len,output,
			  output_len,&remlen,D23_COMPARE,rsrqpb);
	}
    ...
    *output_len -= remlen;
    ...
    {                   /*  update cache if necessary                 */
      d26_h01_cache_update(*output,D23_COMPARE,d26_dir_id,d26_serv_contr,
	d26_base_object);
    }
    free(s_i_apdu);
  }

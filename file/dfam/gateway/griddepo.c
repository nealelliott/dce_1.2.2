 ...
 * HISTORY
 * $Log: griddepo.c,v $
 * Revision 1.1.2.3  1996/03/22  07:36:28  takano
 * 	modified the table deletion method in the POST routine.
 * 	[1996/03/22  07:33:00  takano]
 *
 * Revision 1.1.2.2  1996/03/11  14:08:51  marty
 * 	Update OSF copyright years.
 * 	[1996/03/11  13:58:03  marty]
 * 
 * Revision 1.1.2.1  1996/02/21  08:12:39  takano
 * 	First Submit
 * 	[1996/02/21  08:12:31  takano]
 * 
 * $EndLog$
 */
...
/*EnglishComment**************************************************************/
/* ID   = Post_Deletedir                                                     */
/* name = Redirection of deleting directory (post-hook)                      */
...
int Post_Deletedir(DeleteDirCallBackStruct *pddcbs, LONG uiNWerrno_result)
{
	...
	pAcs_t = SerchAccessList(pddcbs->connection, 0L, DELETEDIR_ACCESS);
	if (pAcs_t != NULL)	{

 ...
 * HISTORY
 * $Log: matriximpl.h,v $
 * Revision 1.1.2.2  1996/03/09  20:49:41  marty
 * 	Add OSF copyright
 * 	[1996/03/09  20:28:01  marty]
 *
 * Revision 1.1.2.1  1995/12/11  19:35:31  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  19:18:39  root]
 * 
 * $EndLog$
 */
#ifndef matrix_i_h
...
class matrixImpl : public Matrix {
	...
	void IDL_STD_STDCALL set(
	      ...
	      /* [in] */ idl_long_float value
	    	...
	    	bh = get_binding_handle();
	    	if (reference_monitor(bh, &st) == GRANT_ACCESS) {

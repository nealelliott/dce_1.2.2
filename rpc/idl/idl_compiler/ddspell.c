 ...
 * HISTORY
 * $Log: ddspell.c,v $
 * Revision 1.1.10.2  1996/02/18  18:51:37  marty
 * 	Update OSF copyright years
 * 	[1996/02/18  18:05:09  marty]
 *
 * Revision 1.1.10.1  1995/12/07  22:16:31  root
 * 	Submit OSF/DCE 1.2.1
 * 
 * 	HP revision /main/HPDCE02/jrr_1.2_mothra/1  1995/11/20  20:08 UTC  jrr
 * 	Merge second XIDL drop for DCE 1.2.1
 * 	[1995/11/17  17:03 UTC  dat  /main/dat_xidl2/1]
 * 
 * 	oct 95 idl drop
 * 	[1995/10/23  00:43:24  bfc]
 * 	 *
 * 	may 95 idl drop
 * 	[1995/10/21  22:56:29  bfc]
 * 	 *
 * 	DCE for DEC OSF/1: populate from OSF DCE 1.1
 * 	[1995/10/21  17:24:04  bfc]
 * 	 *
 * 
 * 	HP revision /main/HPDCE02/2  1994/08/03  18:41 UTC  lmm
 * 	Merging Mothra up to DCE 1.1
 * 	[1995/12/07  21:11:06  root]
 * 
 * Revision 1.1.5.4  1993/11/11  21:58:31  sanders
 * 	Added extra endif for call to HP_rpc_ss_ndr_marsh_interp
 * 	[1993/11/11  21:58:03  sanders]
 * 
 * Revision 1.1.5.3  1993/11/03  17:36:40  lmm
 * 	DTS CHFts09415: No marshall routine with -DINSTRUMENTED
 * 	Fix: moved spelling of #ifdef INSTRUMENTED to GEN_INTERP_RTN_CALL
 * 	[1993/11/03  17:36:18  lmm]
 * 
 * Revision 1.1.5.2  1993/10/21  20:36:03  lmm
 * 	Merged tracing functionality into new 1.0.3 backend
 * 	[1993/10/21  20:35:29  lmm]
 * 
 * Revision 1.1.3.3  1993/09/15  15:19:56  root
 * 	    Loading drop DCE1_0_3b03
 * 
 * Revision 1.1.5.3  1994/07/19  17:12:08  tom
 * 	Declare IDL_rtn_vec with new typedef (still OT 10787).
 * 	[1994/07/19  16:57:32  tom]
 * 
 * Revision 1.1.5.2  1994/07/18  15:06:46  tom
 * 	Bug 10787 - Cast values of IDL_rtn_vec.
 * 	[1994/07/15  20:20:10  tom]
 * 
 * Revision 1.1.5.1  1994/07/13  18:56:07  tom
 * 	Bug 10103 - Reduce little-endian bias of stubs
 * 	[1994/07/12  18:49:26  tom]
 * 
 * Revision 1.1.2.2  1993/07/07  19:57:53  ganni
 * 	reduced stub idl sources
 * 	[1993/07/07  19:31:18  ganni]
 * 
 * $EndLog$
 */
/*
...
#else
(fid, vip, cmd_opt, cmd_val, client_side)
    FILE                *fid;       /* [in] output file handle */
    DDBE_vectors_t      *vip;       /* [in] vector information pointer */
    boolean             *cmd_opt;   /* [in] array of cmd option flags */
    void                **cmd_val;  /* [in] array of cmd option values */
...
#endif
{
    ...
    shortint = (unsigned short)(int_p->version % 65536);

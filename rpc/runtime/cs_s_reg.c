 ...
 * HISTORY
 * $Log: cs_s_reg.c,v $
 * Revision 1.1.4.3  1996/02/18  00:03:10  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  22:55:43  marty]
 *
 * Revision 1.1.4.2  1996/02/07  17:48:11  parul
 * 	DCE 1.2.1 final drop from HP
 * 	[1996/02/07  16:13:57  parul]
 * 
 * 	DCE 1.2.1 final drop from HP
 * 
 * Revision 1.1.2.2  1994/06/10  20:54:45  devsrc
 * 	cr10871 - fix copyright
 * 	[1994/06/10  15:00:11  devsrc]
 * 
 * Revision 1.1.2.1  1994/02/08  21:35:08  mori_m
 * 	CR 9701:  Initial submission for RPC runtime I18N support
 * 	[1994/02/08  21:34:57  mori_m]
 * 
 * $EndLog$
 */
/*
...
#include <cs_s.h>		/* For dce_langinfo() 9.0.x specific call */
#include <langinfo.h>
...
*/
PRIVATE
void rpc__codesets_really_read_file
#ifdef _DCE_PROTO_
(
	void
)
...
*/
PRIVATE
void rpc__codesets_read_registry_file
#ifdef _DCE_PROTO_
(
...
#else
	current_codeset = nl_langinfo(CODESET);  /* broken on 9.0 UX platforms */
#endif
	dce_cs_loc_to_rgy(

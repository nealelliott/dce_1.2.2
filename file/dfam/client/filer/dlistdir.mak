...
FIRSTCPP =             
RC = rc
CFLAGS_D_DEXE = /nologo /G2 /Zp1 /Gy /W3 /Gf /Zi /AL /Od /D "_DEBUG" /D "_DOS" /D "JAPANESE" /FR /Fd"DLISTDIR.PDB"
...
DLISTDIR_DEP = c:\client\filer\cli_filr.h \
...
DLISTDIR.OBJ:	DLISTDIR.C $(DLISTDIR_DEP)
	$(CC) $(CFLAGS) $(CCREATEPCHFLAG) /c DLISTDIR.C

$(PROJ).EXE::	DLISTDIR.OBJ $(OBJS_EXT) $(DEFFILE)
	echo >NUL @<<$(PROJ).CRF
DLISTDIR.OBJ +
$(OBJS_EXT)
$(PROJ).EXE

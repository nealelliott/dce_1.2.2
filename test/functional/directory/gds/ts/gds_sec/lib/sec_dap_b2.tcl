...
# 
# HISTORY
# $Log: sec_dap_b2.tcl,v $
# Revision 1.1.4.2  1996/03/11  02:34:37  marty
# 	Update OSF copyright years
# 	[1996/03/10  19:40:00  marty]
#
# Revision 1.1.4.1  1995/12/11  15:25:12  root
# 	Submit
# 	[1995/12/11  14:35:55  root]
# 
# Revision 1.1.2.1  1994/07/06  15:10:41  marrek
# 	Created in July 1994 code drop.
# 	[1994/07/06  13:02:30  marrek]
# 
# $EndLog$
#
# $RCSfile: sec_dap_b2.tcl,v $ $Revision: 1.1.4.2 $ $Date: 1996/03/11 02:34:37 $
#
#######################################################################
#    FILE : sec_dap_b2.tcl                                            #
#    TYPE : gdscp script                                              #
#    DESCRIPTION : test of local DAP bind , DCE + simple will succeed #
#######################################################################

set testid sec_dap_b2
puts "TEST : $testid"

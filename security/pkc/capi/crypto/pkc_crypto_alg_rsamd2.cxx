...
/*
 * HISTORY
 * $Log: pkc_crypto_alg_rsamd2.cxx,v $
 * Revision 1.1.2.1  1996/11/13  20:31:25  arvind
 * 	OSF DCE 1.2.2 Drop 5
 * 	[1996/11/13  20:20:37  arvind]
 *
...
#define ALGORITHM_NAME "RSAwithMD2"

unsigned char rsa_md2_oid[5] = {
...
static unsigned32 verify_rtn (void ** context,
    ...
    return sec_bsafe_verify_data(sec_sign_md2rsa,
                                 &data,
                                 &public_key,
				 &signature);
}		       
...
pkc_signature_algorithm_t pkc_crypto_alg_rsamd2 = {
    pkc_V1,		    // Version
    {sizeof(rsa_md2_oid),   // OID.length
     rsa_md2_oid	    // OID.elements
    },
    {0,			    // flags.threadsafe

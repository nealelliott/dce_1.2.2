 ...
 * HISTORY
 * $Log: server6.c,v $
 * Revision 1.1.4.2  1996/02/17  23:28:51  marty
 * 	Update OSF copyright year
 * 	[1996/02/17  22:45:41  marty]
 *
 * Revision 1.1.4.1  1995/12/11  22:45:58  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  22:21:52  root]
 * 
 * Revision 1.1.2.2  1994/10/06  20:46:29  agd
 * 	expand copyright
 * 	[1994/10/06  14:32:53  agd]
 * 
 * Revision 1.1.2.1  1994/09/19  18:20:17  bhaim
 * 	multidelegate test
 * 	[1994/09/19  17:51:43  bhaim]
 * 
 * $EndLog$
 */
/*
...
string_conv6_v1_0_epv_t string_conv6_v1_0_s_epv =
    { string_convert_uppercase6 };

#define IFSPEC                  string_conv6_v1_0_s_ifspec
#define MANAGER_EPV             (rpc_mgr_epv_t) &string_conv6_v1_0_s_epv
...
setup_sigcatch(&sigcatch_thread);
    ...
    */
   establish_identity(
      string_conv6_AUTHN_SVC,
      (unsigned char *)string_conv6_SERVER_PRINCIPAL_NAME,

 ...
 * HISTORY
 * $Log: method_vary.c,v $
 * Revision 1.1.4.2  1996/02/18  00:32:36  marty
 * 	Update OSF copyright years
 * 	[1996/02/17  23:18:06  marty]
 *
 * Revision 1.1.4.1  1995/12/11  19:49:10  root
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  19:25:34  root]
 * 
 * 	Submit OSF/DCE 1.2.1
 * 	[1995/12/11  18:16:53  root]
 * 
 * Revision 1.1.2.2  1994/09/23  19:39:05  mori_m
 * 	CR 11041/11044: New test for varying array operation.
 * 	[1994/09/23  18:31:11  mori_m]
 * 
 * $EndLog$
 */
...
void client()
{
	...
	mtet_infoline("test case (cs_byte client_method_vary_array)\n");
	...
	fp_out = fopen("./i18n_method_vary_result_file", "w");
	...
	while (rpc_num <= 4)
	{
		...
		temp_status = cs_vary_trans(bind_handle, (long)length + 1, net_string, loc_string);
